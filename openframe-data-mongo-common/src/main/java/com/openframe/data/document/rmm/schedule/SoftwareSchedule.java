...
@NoArgsConstructor
@AllArgsConstructor
@Document(collection = "software_schedules")
@CompoundIndex(def = "{'tenantId': 1, 'name': 1}")
@CompoundIndex(name = "status_nextRunAt", def = "{'status': 1, 'nextRunAt': 1}")
public class SoftwareSchedule implements TenantScoped {
