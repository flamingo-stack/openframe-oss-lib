...
import { LOG_SEVERITY_COLORS, LOG_SEVERITY_LABELS, LogSeverityDotProps } from '../types/logs.types';
import { cn } from '../utils/cn';

export const LogSeverityDot = React.forwardRef<HTMLDivElement, LogSeverityDotProps>(
