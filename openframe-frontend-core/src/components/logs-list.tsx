...
import { LogEntry, LogsListProps } from '../types/logs.types';
...
export const LogsList = React.forwardRef<HTMLDivElement, LogsListProps>(
  (
    {
      logs,
      maxHeight = '400px',
    ...
    return (
      <div
        ...
        style={getContainerStyles()}
      >
        <div ref={containerRef} className="overflow-y-auto px-4 py-3 flex-1">
          {logs.map((log, index) => (
            <LogCard
              key={log.id}
              log={log}
