...
import type { MessageSegment, PendingApproval, ProcessedMessage } from '../types';
 ...
 */
export function extractIncompleteMessageState(lastMessage: ProcessedMessage | undefined):
  | {
