...
const ChatMessageList = forwardRef<HTMLDivElement, ChatMessageListProps>(
  (
    ...
    }, [autoScroll, messages.length, dialogId, scrollToBottomDeferred, startAnchoringWatch, messages]);
    ...
    useLayoutEffect(() => {
      ...
      if (!el) {
        prependRef.current = {
          ...
          scrollHeight: 0,
          dialogId: prependRef.current.dialogId,
        };
        return;
      }
    ...
    return (
      <div className="relative flex-1 min-h-0 flex flex-col">
        ...
        >
          <div
            className={cn('mx-auto flex w-full max-w-3xl flex-col pb-2 min-w-0', contentClassName || 'px-4')}
            style={{ minHeight: '100%' }}
          >
            {/* Infinite scroll sentinel */}
            {hasNextPage && <div ref={sentinelRef} className="h-px" style={{ overflowAnchor: 'none' }} />}
