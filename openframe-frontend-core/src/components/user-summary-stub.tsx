...
const getAuthProviderIcon = (provider: string) => {
  ...
  switch (p) {
    ...
    case 'slack':
    case 'slack_oidc':
      return <div className="w-4 h-4 bg-ods-text-secondary rounded-full" />; // Slack icon stub
    default:
        ...
        <div className="relative shrink-0" style={{ width: avatarSize, height: avatarSize }}>
          <div className="rounded-lg overflow-hidden bg-ods-card border border-ods-border w-full h-full relative">
            {avatarUrl ? (
              ...
              <div className="flex items-center justify-center h-full w-full bg-ods-open-yellow text-ods-bg font-['Azeret_Mono'] font-bold">
                {name
                  .split(' ')
          ...
          {mspPreview && mspPreview.logoUrl && (
            <div className="absolute -bottom-1 -right-1 size-6 rounded-full bg-ods-bg-inverted ring-1 ring-ods-bg overflow-hidden flex items-center justify-center select-none z-10">
              <img
    ...
    <div className="flex flex-col gap-4 w-full">
      ...
      <div className="flex gap-6 w-full items-start">
        ...
        <div className="relative shrink-0 h-24 w-24 overflow-visible">
          ...
          {mspPreview && (
            <div className="absolute -bottom-1 -right-1 size-10 rounded-full bg-ods-bg-inverted ring-2 ring-ods-bg overflow-hidden flex items-center justify-center select-none">
              {mspPreview.logoUrl ? (
                <Image
                  src={getProxiedImageUrl(mspPreview.logoUrl) ?? mspPreview.logoUrl}
                ...
                <span className="text-ods-bg font-['Azeret_Mono'] text-sm font-bold">
