...
export function CommentCard({
  ...
  return (
    <div
      className="bg-ods-card border border-ods-border rounded-lg p-4 hover:border-ods-open-yellow transition-all group overflow-hidden w-full max-w-full box-border"
      ...
      >
        {comment.title && (
          <div className={compact ? 'h-[20px] flex items-center' : 'h-[24px] flex items-center'}>
            <h4
              className="text-h3 tracking-[-0.02em] text-ods-text-primary group-hover:text-ods-accent transition-colors line-clamp-1"
              style={{
        ...
        <div className={compact ? 'h-[60px] flex items-center' : 'h-[72px] flex items-center'}>
          <p
            className="text-h4 text-ods-text-primary line-clamp-3"
            style={{
              wordBreak: 'break-word',
              overflowWrap: 'break-word',
              maxWidth: '100%',
