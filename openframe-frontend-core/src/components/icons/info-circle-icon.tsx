...
export function InfoCircleIcon({ className = '', color = 'currentColor', size, width, height }: InfoCircleIconProps) {
  const w = size || width || 24;
  const h = size || height || 24;

  return (
    <svg width={w} height={h} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className={className}>
      <path
