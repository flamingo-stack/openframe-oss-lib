  ...
  const renderMediaItem = useCallback(
    (mediaItem: MediaItem, index: number) => {
      ...
      return (
        <Card
          key={index}
          className="relative group border-ods-border hover:border-ods-open-yellow/30 transition-colors"
          draggable
        ...
        >
          ...
          {/* Media Content */}
          <div className="aspect-video relative bg-ods-text-on-accent rounded-lg overflow-hidden">
