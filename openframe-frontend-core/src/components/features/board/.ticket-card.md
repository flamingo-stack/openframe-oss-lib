...
|---|---|---|
| `TicketCardBody` | Component | Pure presentational inner content — title, device/org row, priority flag, assignees, tags, the `<ticketNumber> • <relative time>` line (either half alone when the other is missing), new message badge, and approval row |
