  ...
  return (
    <div className={cn('flex items-center gap-2 min-w-0', className)}>
      ...
      <div className="min-w-0 flex-1">
        <p className="font-['DM_Sans'] text-lg leading-[22px] text-ods-text-primary truncate">{name}</p>
        {subtitle && (
          <span className="font-['DM_Sans'] text-md leading-[16px] text-ods-text-secondary truncate">{subtitle}</span>
        )}
      </div>
    </div>
  );
