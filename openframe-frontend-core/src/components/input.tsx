  ...
  return (
    <input
      ...
      className={cn(
        ...
        "ring-offset-background file:border-0 file:bg-transparent file:text-h4",
        // Focus & disabled states
        "placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ods-accent/20 focus-visible:ring-offset-0 disabled:cursor-not-allowed disabled:bg-ods-bg",
        // Animations & touch UX
