  ...
  "whitespace-nowrap inline-flex items-center justify-center gap-1 md:gap-2 rounded-[6px] font-['DM_Sans'] font-bold text-xs md:text-lg leading-tight transition-colors duration-200 focus-visible:outline-none disabled:pointer-events-none [&_svg]:pointer-events-none [&_svg]:shrink-0 !w-full md:!w-auto text-center",
  {
    variants: {
      variant: {
        ...
        primary:
          'bg-ods-accent text-ods-text-on-accent hover:bg-ods-accent-hover active:bg-ods-accent-active focus-visible:ring-2 focus-visible:ring-ods-focus disabled:bg-ods-disabled disabled:text-ods-text-secondary disabled:cursor-not-allowed disabled:shadow-none',
        // White background variant for secondary actions (ButtonFull secondary)
        white:
          'bg-white text-black hover:bg-ods-text-secondary hover:text-black active:bg-ods-text-muted active:text-black focus-visible:ring-2 focus-visible:ring-ods-focus disabled:bg-ods-disabled disabled:text-ods-text-secondary disabled:cursor-not-allowed disabled:shadow-none',
        // Secondary variant for alternative actions (ButtonFull secondary)
        secondary:
          'bg-ods-text-primary text-black hover:bg-ods-text-secondary hover:text-black active:bg-ods-text-muted active:text-black focus-visible:ring-2 focus-visible:ring-ods-focus disabled:bg-ods-disabled disabled:text-ods-text-secondary disabled:cursor-not-allowed disabled:shadow-none',
        // Outline variant for Submit Product buttons and secondary actions
        outline:
          'border border-ods-border bg-transparent text-ods-text-primary hover:bg-ods-bg-hover active:bg-ods-bg-active focus-visible:ring-2 focus-visible:ring-ods-focus disabled:border-ods-disabled disabled:text-ods-text-secondary disabled:bg-ods-disabled disabled:cursor-not-allowed disabled:shadow-none',
        // Transparent variant for ghost-like actions (ButtonFull transparent)
        transparent:
          'bg-transparent text-ods-text-primary hover:bg-ods-bg-hover active:bg-ods-bg-active focus-visible:ring-2 focus-visible:ring-ods-focus disabled:text-ods-text-disabled !w-auto whitespace-nowrap !text-base',
        // Ghost variant for subtle interactions
        ghost:
          'bg-transparent text-ods-text-primary hover:bg-ods-bg-hover active:bg-ods-bg-active focus-visible:ring-2 focus-visible:ring-ods-focus disabled:text-ods-text-disabled !w-auto whitespace-nowrap !text-base',
        // Ghost navigation variant - left-aligned for navigation menus
        'ghost-nav':
          'bg-transparent text-ods-text-primary hover:bg-ods-bg-hover active:bg-ods-bg-active focus-visible:ring-2 focus-visible:ring-ods-focus disabled:text-ods-text-disabled justify-start !w-auto whitespace-nowrap !text-base',
        ...
        search:
          'bg-ods-card border border-ods-border text-ods-text-primary hover:bg-ods-bg-hover hover:border-ods-border focus-visible:ring-2 focus-visible:ring-ods-focus disabled:bg-ods-disabled disabled:text-ods-text-disabled',
        // Special variant for submit product buttons (header usage)
        submit:
          'border border-ods-border bg-transparent text-ods-text-primary hover:bg-ods-bg-hover focus:bg-ods-bg-hover focus-visible:ring-2 focus-visible:ring-ods-focus disabled:border-ods-disabled disabled:text-ods-text-disabled',
        // Destructive variant for dangerous actions
        destructive:
          'bg-ods-error text-ods-text-on-dark hover:bg-ods-error-hover active:bg-ods-error-active focus-visible:ring-2 focus-visible:ring-ods-focus disabled:bg-ods-disabled disabled:text-ods-text-disabled',
        // Success variant for positive actions
        success:
          'bg-ods-success text-ods-text-on-dark hover:bg-ods-success-hover active:bg-ods-success-active focus-visible:ring-2 focus-visible:ring-ods-focus disabled:bg-ods-disabled disabled:text-ods-text-disabled',
        // Warning variant for cautionary actions
        warning:
          'bg-ods-warning text-ods-text-on-accent hover:bg-ods-warning-hover active:bg-ods-warning-active focus-visible:ring-2 focus-visible:ring-ods-focus disabled:bg-ods-disabled disabled:text-ods-text-disabled',
        ...
        section:
          'bg-ods-card border border-ods-border shadow-ods-card !text-left !justify-start !items-start transition-all duration-200 hover:bg-ods-card-hover disabled:opacity-50 disabled:cursor-not-allowed',
        'section-active':
          'bg-ods-card border border-ods-accent shadow-ods-card !text-left !justify-start !items-start transition-all duration-200 hover:bg-ods-card-hover disabled:opacity-50 disabled:cursor-not-allowed',
        ...
        'device-action':
          'bg-ods-card border border-ods-border hover:bg-ods-bg-hover text-ods-text-primary px-4 py-3 rounded-[6px] text-h3 tracking-[-0.36px] disabled:opacity-50 disabled:cursor-not-allowed disabled:bg-ods-card disabled:text-ods-text-secondary',
  ...
  (
    ...
    const renderContent = () => {
      ...
      if (isCenterIconOnly && !loading) {
        return <span className="flex items-center justify-center">{centerIcon}</span>;
      }
      ...
      if (!isCenterIconOnly) {
        return (
          <>
            {leftIcon && !loading && (
              <span className="flex items-center justify-center [&_svg]:w-4 [&_svg]:h-4 md:[&_svg]:w-6 md:[&_svg]:h-6">
                {leftIcon}
              </span>
            )}
            {loading && (
    ...
    if (asChild) {
      return (
        <Slot className={composedClassName} ref={ref} {...props}>
          {children}
        </Slot>
      );
    }
    ...
    return (
      <button className={composedClassName} ref={ref} disabled={isDisabled} onClick={onClick} {...props}>
        {renderContent()}
      </button>
    );
  },
