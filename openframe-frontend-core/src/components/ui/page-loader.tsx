...
export function PageLoader({
  ...
  return (
    <div className={cn('bg-ods-bg flex flex-col items-center justify-center min-h-screen w-full', className)}>
      <div className="flex flex-col items-center gap-6 p-6">
        ...
        <div className="flex flex-col items-center text-center">
          <p className="text-lg font-medium text-ods-text-tertiary leading-6">{title}</p>
          <p className="text-sm font-medium text-ods-text-tertiary opacity-70 leading-5 mt-1">{description}</p>
        </div>
      </div>
    </div>
  );
  ...
  return (
    <div className={cn('flex flex-col items-center justify-center p-12', className)}>
      <div className="flex flex-col items-center gap-4">
        ...
        <div className="flex flex-col items-center text-center">
          <p className="text-base font-medium text-ods-text-tertiary">{title}</p>
          {description && <p className="text-sm text-ods-text-tertiary opacity-70 mt-1">{description}</p>}
        </div>
      </div>
    </div>
  );
