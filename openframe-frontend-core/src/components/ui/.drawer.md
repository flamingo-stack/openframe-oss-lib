...
| `size` | `"default" \| "wide"` | `"default"` | Panel size preset; `wide` is 90% of the viewport. Use it instead of a width class. Not combinable with `resizable` (the handle owns the size; a type error) |
