    ...
    <>
      <div className={cn('relative w-full h-14 border-b border-ods-border', className)}>
        ...
        {canScrollLeft && (
          <div
            className={cn(
              'absolute left-0 top-0 w-10 h-14 pointer-events-none bg-gradient-to-r to-transparent',
        ...
        {canScrollRight && (
          <div
            className={cn(
              'absolute right-0 top-0 w-10 h-14 pointer-events-none bg-gradient-to-l to-transparent',
              shadowClassName || 'from-ods-bg',
            )}
          />
        )}
