<!-- source-hash: 1bdad2e97b232d088c3f34ea1721e212 -->
...
- `currentAssignee.deleted` — deleted account: the avatar is replaced by `DeletedUserAvatar` (red user-x) and the name renders in `text-ods-error` (default variant).
