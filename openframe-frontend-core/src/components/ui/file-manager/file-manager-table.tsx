    ...
    return (
      <div className={cn('bg-ods-bg border border-ods-border rounded-lg flex flex-col', className)}>
        ...
        <div className="flex items-center h-12 px-4 bg-ods-bg-secondary border-b border-ods-border rounded-t-lg">
          ...
          <div className="flex items-center gap-3 flex-1 min-w-0 text-sm font-medium text-ods-text-secondary">NAME</div>

          <div className="w-24 shrink-0 pr-4 text-sm font-medium text-ods-text-secondary">SIZE</div>

          <div className="w-36 shrink-0 pl-4 text-sm font-medium text-ods-text-secondary">EDITED</div>

          <div className="w-48 shrink-0 pl-4 flex justify-end">{/* Space for action buttons */}</div>
        </div>
            ...
            <div key={idx} className="bg-ods-card group flex items-center h-16 px-4 border-ods-border">
              ...
              <div className="flex items-center gap-3 flex-1 min-w-0">
                ...
                <div className="flex flex-col min-w-0">
                  ...
                  {isSearchResult && <Skeleton className="h-3 w-48 mt-1" />}
                </div>
              </div>
