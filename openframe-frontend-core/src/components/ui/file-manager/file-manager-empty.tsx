...
export function FileManagerEmpty({
  ...
  return (
    <div className={cn('flex flex-col items-center justify-center py-20 px-4', className)}>
      ...
      <h3 className="text-lg font-medium text-ods-text-primary mb-2">{message}</h3>

      <p className="text-sm text-ods-text-secondary text-center max-w-md mb-6">{description}</p>
