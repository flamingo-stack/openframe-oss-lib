  ...
  ({ className, type, invalid = false, startAdornment, endAdornment, preview = false, ...props }, ref) => {
    ...
    if (preview) {
      return (
        <div
          className={cn(
            // Layout & spacing
            "flex items-center gap-2 rounded-[6px] border px-3 h-11 sm:h-12",
            // Theme palette
    ...
    if (hasAdornments) {
      return (
        <label
          className={cn(
            // Layout & spacing
            "flex items-center gap-2 rounded-[6px] border px-3 h-11 sm:h-12 cursor-text",
            // Focus-within states
    ...
    return (
      <input
        ...
        className={cn(
          // Layout & spacing
          "flex items-center rounded-[6px] border px-3 h-11 sm:h-12",
          // Typography
          "text-[18px] font-medium leading-6",
          // File input adjustments
