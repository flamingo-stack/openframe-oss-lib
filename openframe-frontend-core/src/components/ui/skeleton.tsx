...
const SkeletonText = React.forwardRef<HTMLDivElement, SkeletonTextProps>(({ lines = 1, className, ...props }, ref) => {
  return (
...
const SkeletonCard = React.forwardRef<HTMLDivElement, SkeletonCardProps>(
  ({ showImage = false, className, ...props }, ref) => {
    return (
      <div ref={ref} className={cn('rounded-lg border border-ods-border overflow-hidden', className)} {...props}>
...
const SkeletonList = React.forwardRef<HTMLDivElement, SkeletonListProps>(({ items = 5, className, ...props }, ref) => {
  return (
