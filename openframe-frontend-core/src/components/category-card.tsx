...
export function CategoryCard({ name, description, categoryCount, productCount, icons = [] }: CategoryCardProps) {
  return (
    <article className="bg-ods-text-on-accent border border-ods-border-hover rounded-[12px] p-8 flex flex-col min-w-0 box-border">
      ...
      <div className="flex-1 flex flex-col">
        ...
        <div className="flex flex-row items-start">
          ...
          <button
            className="w-12 h-12 flex items-center justify-center border border-ods-border rounded-[6px] bg-transparent hover:bg-ods-open-yellow transition-colors ml-4"
