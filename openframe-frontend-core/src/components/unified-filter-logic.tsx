...
export function useUnifiedFiltering(config: FilterConfig) {
  ...
  const addFilter = (type: keyof FilterState, value: string, preserveScroll = false) => {
    const currentState = getCurrentFilterState();
  ...
  const removeFilter = (type: keyof FilterState, value?: string, preserveScroll = true) => {
    const currentState = getCurrentFilterState();
    const updates: Partial<FilterState> = {};
  ...
  const toggleFilter = (type: keyof FilterState, value: string, preserveScroll = false) => {
    const currentState = getCurrentFilterState();
