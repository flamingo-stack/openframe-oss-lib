  ...
  return (
    <div className="p-8 space-y-8 bg-ods-bg min-h-screen">
      <div className="max-w-4xl mx-auto space-y-6">
        <h1 className="text-3xl font-bold text-ods-text-primary mb-4">ODS Current Color Token Test</h1>

        <p className="text-ods-text-secondary mb-8">
          The boxes below should show platform-specific colors using the{' '}
          <code className="bg-ods-card px-2 py-1 rounded">ods-current</code> token.
        </p>

        {/* Text Color Test */}
        <div className="bg-ods-card p-6 rounded-lg border border-ods-border">
          <h2 className="text-xl font-semibold text-ods-text-primary mb-4">Text Color Test</h2>
          <p className="text-ods-current text-2xl font-bold">This text uses text-ods-current</p>
        ...
        <div className="bg-ods-card p-6 rounded-lg border border-ods-border">
          <h2 className="text-xl font-semibold text-ods-text-primary mb-4">Background Color Test</h2>
          <div className="bg-ods-current p-4 rounded">
            <p className="text-black font-semibold">This box uses bg-ods-current</p>
          </div>
          <p className="text-sm text-ods-text-secondary mt-2">
        ...
        {/* Border Color Test */}
        <div className="bg-ods-card p-6 rounded-lg border border-ods-border">
          <h2 className="text-xl font-semibold text-ods-text-primary mb-4">Border Color Test</h2>
        ...
        {/* SVG Fill Test */}
        <div className="bg-ods-card p-6 rounded-lg border border-ods-border">
          <h2 className="text-xl font-semibold text-ods-text-primary mb-4">SVG Fill Test</h2>
        ...
        {/* CSS Variable Test */}
        <div className="bg-ods-card p-6 rounded-lg border border-ods-border">
          <h2 className="text-xl font-semibold text-ods-text-primary mb-4">CSS Variable Direct Usage</h2>
          <div
            style={{
        ...
        <div className="bg-ods-card p-6 rounded-lg border border-ods-border">
          <h2 className="text-xl font-semibold text-ods-text-primary mb-4">Current Platform Context</h2>
          <p className="text-ods-text-secondary">
            Check the <code className="bg-ods-bg px-2 py-1 rounded">data-app-type</code> attribute on the root element
            to see which platform theme is active.
          </p>
          <div className="mt-4 space-y-2 text-sm">
            <div className="flex gap-2">
              <span className="text-ods-text-secondary">OpenFrame:</span>
              <span className="text-ods-open-yellow">Yellow (#ffc008)</span>
            </div>
            <div className="flex gap-2">
              <span className="text-ods-text-secondary">Flamingo:</span>
              <span className="text-ods-flamingo-pink">Pink (#f357bb)</span>
            </div>
            <div className="flex gap-2">
