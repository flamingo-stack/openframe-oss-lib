...
const FormDescription = forwardRef<HTMLParagraphElement, HTMLAttributes<HTMLParagraphElement>>(
  ({ className, ...props }, ref) => {
    ...
    return <p ref={ref} id={formDescriptionId} className={cn('text-muted-foreground text-h6', className)} {...props} />;
  },
);
...
const FormMessage = forwardRef<HTMLParagraphElement, HTMLAttributes<HTMLParagraphElement>>(
  ({ className, children, ...props }, ref) => {
    ...
    return (
      <p ref={ref} id={formMessageId} className={cn('text-destructive text-h6', className)} {...props}>
        {body}
      </p>
    );
  },
