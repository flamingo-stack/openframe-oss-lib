    ...
    >
      ...
      >
        ...
        <div className="flex items-center justify-start flex-shrink-0">
          {config.actions?.left && <div className="flex items-center">{config.actions.left}</div>}
        ...
        <div className="flex items-center justify-end gap-4 flex-shrink-0">
          {/* Desktop Actions */}
          {config.actions?.right && <div className="hidden md:flex items-center gap-4">{config.actions.right}</div>}
