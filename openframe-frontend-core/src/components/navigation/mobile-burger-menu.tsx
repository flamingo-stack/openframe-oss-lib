  ...
  return (
    <>
      ...
      >
            ...
            <div className="flex items-center gap-3 p-3 bg-ods-card border border-ods-border rounded-md">
              ...
              <div className="flex-1 min-w-0 flex flex-col">
                <div className="flex items-center gap-2">
                  <span className="font-medium text-sm text-ods-text-primary truncate">{user.userName || 'User'}</span>
                  {user.userRole && (
                ...
                {user.userEmail && (
                  <span className="font-medium text-xs text-ods-text-secondary truncate">{user.userEmail}</span>
                )}
              </div>
        ...
        {/* Footer */}
        {config.footer && <div className="border-t border-ods-border p-4 shrink-0">{config.footer}</div>}
      </div>
    </>
  );
}
