...
export interface FlaskVialIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function FlaskVialIcon({ className = '', size = 24, color = 'currentColor', ...props }: FlaskVialIconProps) {
  return (
    <svg
