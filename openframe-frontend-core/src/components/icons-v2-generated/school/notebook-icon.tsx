...
export interface NotebookIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function NotebookIcon({ className = '', size = 24, color = 'currentColor', ...props }: NotebookIconProps) {
  return (
    <svg
