...
export interface BookTextIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function BookTextIcon({ className = '', size = 24, color = 'currentColor', ...props }: BookTextIconProps) {
  return (
    <svg
