...
export interface VialIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function VialIcon({ className = '', size = 24, color = 'currentColor', ...props }: VialIconProps) {
  return (
    <svg
