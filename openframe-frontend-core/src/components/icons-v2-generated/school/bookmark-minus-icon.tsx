...
export interface BookmarkMinusIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function BookmarkMinusIcon({
  ...
  return (
    ...
    >
      ...
      />
      <path fill={color} d="M15 8.375a1.125 1.125 0 0 1 0 2.25H9a1.125 1.125 0 0 1 0-2.25z" />
    </svg>
  );
}
