...
export interface QuoteLeftIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function QuoteLeftIcon({ className = '', size = 24, color = 'currentColor', ...props }: QuoteLeftIconProps) {
  return (
    <svg
