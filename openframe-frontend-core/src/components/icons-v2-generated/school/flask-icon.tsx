...
export interface FlaskIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function FlaskIcon({ className = '', size = 24, color = 'currentColor', ...props }: FlaskIconProps) {
  return (
    <svg
