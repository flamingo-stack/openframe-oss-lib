...
export interface NotebookAltIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function NotebookAltIcon({ className = '', size = 24, color = 'currentColor', ...props }: NotebookAltIconProps) {
  return (
    <svg
