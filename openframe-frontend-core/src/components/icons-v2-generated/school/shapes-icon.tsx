...
export interface ShapesIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function ShapesIcon({ className = '', size = 24, color = 'currentColor', ...props }: ShapesIconProps) {
  return (
    <svg
