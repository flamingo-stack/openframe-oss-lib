...
export interface StationeryIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function StationeryIcon({ className = '', size = 24, color = 'currentColor', ...props }: StationeryIconProps) {
  return (
    <svg
