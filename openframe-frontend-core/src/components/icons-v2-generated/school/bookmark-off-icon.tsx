...
export interface BookmarkOffIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function BookmarkOffIcon({ className = '', size = 24, color = 'currentColor', ...props }: BookmarkOffIconProps) {
  return (
    <svg
