...
export interface BookIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function BookIcon({ className = '', size = 24, color = 'currentColor', ...props }: BookIconProps) {
  return (
    <svg
