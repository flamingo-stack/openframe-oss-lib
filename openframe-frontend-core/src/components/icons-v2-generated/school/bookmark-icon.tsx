...
export interface BookmarkIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function BookmarkIcon({ className = '', size = 24, color = 'currentColor', ...props }: BookmarkIconProps) {
  return (
    <svg
