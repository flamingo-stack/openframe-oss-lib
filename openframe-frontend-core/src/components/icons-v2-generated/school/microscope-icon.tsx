...
export interface MicroscopeIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function MicroscopeIcon({ className = '', size = 24, color = 'currentColor', ...props }: MicroscopeIconProps) {
  return (
    <svg
