...
export interface HonorIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function HonorIcon({ className = '', size = 24, color = 'currentColor', ...props }: HonorIconProps) {
  return (
    <svg
