...
export interface AlphabetXIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function AlphabetXIcon({ className = '', size = 24, color = 'currentColor', ...props }: AlphabetXIconProps) {
  return (
    <svg
