...
export interface AlphabetBIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function AlphabetBIcon({ className = '', size = 24, color = 'currentColor', ...props }: AlphabetBIconProps) {
  return (
    <svg
