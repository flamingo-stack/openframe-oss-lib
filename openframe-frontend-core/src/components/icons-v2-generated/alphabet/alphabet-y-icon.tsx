...
export interface AlphabetYIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function AlphabetYIcon({ className = '', size = 24, color = 'currentColor', ...props }: AlphabetYIconProps) {
  return (
    <svg
