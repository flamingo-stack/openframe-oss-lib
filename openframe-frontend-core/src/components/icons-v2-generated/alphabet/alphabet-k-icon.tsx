...
export interface AlphabetKIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function AlphabetKIcon({ className = '', size = 24, color = 'currentColor', ...props }: AlphabetKIconProps) {
  return (
    <svg
