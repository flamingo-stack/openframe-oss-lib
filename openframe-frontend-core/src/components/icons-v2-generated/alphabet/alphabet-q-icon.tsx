...
export interface AlphabetQIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function AlphabetQIcon({ className = '', size = 24, color = 'currentColor', ...props }: AlphabetQIconProps) {
  return (
    <svg
