...
export interface AlphabetRIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function AlphabetRIcon({ className = '', size = 24, color = 'currentColor', ...props }: AlphabetRIconProps) {
  return (
    <svg
