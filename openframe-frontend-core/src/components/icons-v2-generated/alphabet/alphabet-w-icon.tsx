...
export interface AlphabetWIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function AlphabetWIcon({ className = '', size = 24, color = 'currentColor', ...props }: AlphabetWIconProps) {
  return (
    <svg
