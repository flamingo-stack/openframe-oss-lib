...
export interface AlphabetIIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function AlphabetIIcon({ className = '', size = 24, color = 'currentColor', ...props }: AlphabetIIconProps) {
  return (
    <svg
