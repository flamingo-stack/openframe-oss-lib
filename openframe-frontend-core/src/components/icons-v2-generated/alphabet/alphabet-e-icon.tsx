...
export interface AlphabetEIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function AlphabetEIcon({ className = '', size = 24, color = 'currentColor', ...props }: AlphabetEIconProps) {
  return (
    <svg
