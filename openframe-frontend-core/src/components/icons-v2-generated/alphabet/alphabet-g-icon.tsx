...
export interface AlphabetGIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function AlphabetGIcon({ className = '', size = 24, color = 'currentColor', ...props }: AlphabetGIconProps) {
  return (
    <svg
