...
export interface HotelAltIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function HotelAltIcon({ className = '', size = 24, color = 'currentColor', ...props }: HotelAltIconProps) {
  return (
    <svg
