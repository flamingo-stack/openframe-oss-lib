...
export interface LighthouseIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function LighthouseIcon({ className = '', size = 24, color = 'currentColor', ...props }: LighthouseIconProps) {
  return (
    <svg
