...
export interface CastleIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function CastleIcon({ className = '', size = 24, color = 'currentColor', ...props }: CastleIconProps) {
  return (
    <svg
