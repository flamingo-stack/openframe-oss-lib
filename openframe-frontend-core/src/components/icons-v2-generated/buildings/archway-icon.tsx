...
export interface ArchwayIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function ArchwayIcon({ className = '', size = 24, color = 'currentColor', ...props }: ArchwayIconProps) {
  return (
    <svg
