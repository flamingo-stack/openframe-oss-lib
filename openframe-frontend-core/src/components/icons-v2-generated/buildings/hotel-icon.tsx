...
export interface HotelIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function HotelIcon({ className = '', size = 24, color = 'currentColor', ...props }: HotelIconProps) {
  return (
    <svg
