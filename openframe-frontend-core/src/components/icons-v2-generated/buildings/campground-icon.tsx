...
export interface CampgroundIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function CampgroundIcon({ className = '', size = 24, color = 'currentColor', ...props }: CampgroundIconProps) {
  return (
    <svg
