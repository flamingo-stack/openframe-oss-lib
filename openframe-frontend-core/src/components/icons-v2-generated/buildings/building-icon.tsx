...
export interface BuildingIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function BuildingIcon({ className = '', size = 24, color = 'currentColor', ...props }: BuildingIconProps) {
  return (
    <svg
