...
export interface BuildingsIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function BuildingsIcon({ className = '', size = 24, color = 'currentColor', ...props }: BuildingsIconProps) {
  return (
    <svg
