...
export interface Bridge02IconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function Bridge02Icon({ className = '', size = 24, color = 'currentColor', ...props }: Bridge02IconProps) {
  return (
    <svg
