...
export interface HospitalIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function HospitalIcon({ className = '', size = 24, color = 'currentColor', ...props }: HospitalIconProps) {
  return (
    <svg
