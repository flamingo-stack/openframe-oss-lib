...
export interface ChurchIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function ChurchIcon({ className = '', size = 24, color = 'currentColor', ...props }: ChurchIconProps) {
  return (
    <svg
