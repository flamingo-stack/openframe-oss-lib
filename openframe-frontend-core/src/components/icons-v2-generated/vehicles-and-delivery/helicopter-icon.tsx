...
export interface HelicopterIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function HelicopterIcon({ className = '', size = 24, color = 'currentColor', ...props }: HelicopterIconProps) {
  return (
    <svg
