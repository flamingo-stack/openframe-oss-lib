...
export interface Parcel01IconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function Parcel01Icon({ className = '', size = 24, color = 'currentColor', ...props }: Parcel01IconProps) {
  return (
    <svg
