...
export interface ParcelsIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function ParcelsIcon({ className = '', size = 24, color = 'currentColor', ...props }: ParcelsIconProps) {
  return (
    <svg
