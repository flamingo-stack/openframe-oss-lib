...
export interface HandParcelIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function HandParcelIcon({ className = '', size = 24, color = 'currentColor', ...props }: HandParcelIconProps) {
  return (
    <svg
