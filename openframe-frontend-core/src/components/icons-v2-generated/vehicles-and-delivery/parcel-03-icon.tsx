...
export interface Parcel03IconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function Parcel03Icon({ className = '', size = 24, color = 'currentColor', ...props }: Parcel03IconProps) {
  return (
    <svg
