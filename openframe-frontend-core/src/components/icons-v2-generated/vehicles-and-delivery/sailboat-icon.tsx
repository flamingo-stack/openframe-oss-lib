...
export interface SailboatIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function SailboatIcon({ className = '', size = 24, color = 'currentColor', ...props }: SailboatIconProps) {
  return (
    <svg
