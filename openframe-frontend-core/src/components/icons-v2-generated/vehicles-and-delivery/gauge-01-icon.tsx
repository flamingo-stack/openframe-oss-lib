...
export interface Gauge01IconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function Gauge01Icon({ className = '', size = 24, color = 'currentColor', ...props }: Gauge01IconProps) {
  return (
    <svg
