...
export interface SpeedTrainIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function SpeedTrainIcon({ className = '', size = 24, color = 'currentColor', ...props }: SpeedTrainIconProps) {
  return (
    <svg
