...
export interface RoadBarrierIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function RoadBarrierIcon({ className = '', size = 24, color = 'currentColor', ...props }: RoadBarrierIconProps) {
  return (
    <svg
