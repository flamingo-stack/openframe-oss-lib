...
export interface BikeIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function BikeIcon({ className = '', size = 24, color = 'currentColor', ...props }: BikeIconProps) {
  return (
    <svg
