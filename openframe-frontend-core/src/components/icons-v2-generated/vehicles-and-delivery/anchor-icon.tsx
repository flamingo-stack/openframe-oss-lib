...
export interface AnchorIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function AnchorIcon({ className = '', size = 24, color = 'currentColor', ...props }: AnchorIconProps) {
  return (
    <svg
