...
export interface CarSideIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function CarSideIcon({ className = '', size = 24, color = 'currentColor', ...props }: CarSideIconProps) {
  return (
    <svg
