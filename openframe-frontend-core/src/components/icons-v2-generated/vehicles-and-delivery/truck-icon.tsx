...
export interface TruckIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function TruckIcon({ className = '', size = 24, color = 'currentColor', ...props }: TruckIconProps) {
  return (
    <svg
    ...
    >
      ...
      <path
        fill={color}
        d="M8.875 18a1.875 1.875 0 1 0-3.75 0 1.875 1.875 0 0 0 3.75 0m10 .5a1.375 1.375 0 1 0-2.75.002 1.375 1.375 0 0 0 2.75-.002m2.25 0a3.626 3.626 0 1 1-7.251-.001 3.626 3.626 0 0 1 7.251 0Zm-10-.5a4.125 4.125 0 1 1-8.25 0 4.125 4.125 0 0 1 8.25 0"
      />
    </svg>
  );
}
