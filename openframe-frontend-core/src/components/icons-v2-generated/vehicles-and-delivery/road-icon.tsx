...
export interface RoadIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function RoadIcon({ className = '', size = 24, color = 'currentColor', ...props }: RoadIconProps) {
  return (
    <svg
