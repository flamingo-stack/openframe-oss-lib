...
export interface TrainTunnelIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function TrainTunnelIcon({ className = '', size = 24, color = 'currentColor', ...props }: TrainTunnelIconProps) {
  return (
    <svg
