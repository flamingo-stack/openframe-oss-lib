...
export interface TrolleyIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function TrolleyIcon({ className = '', size = 24, color = 'currentColor', ...props }: TrolleyIconProps) {
  return (
    <svg
