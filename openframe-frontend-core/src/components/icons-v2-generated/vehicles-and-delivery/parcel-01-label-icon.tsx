...
export interface Parcel01LabelIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function Parcel01LabelIcon({
  className = '',
  size = 24,
  color = 'currentColor',
  ...props
}: Parcel01LabelIconProps) {
  return (
    <svg
    ...
    >
      <path
        fill={color}
        d="m9.5 16.875.115.006a1.125 1.125 0 0 1 0 2.239l-.115.005h-3a1.126 1.126 0 0 1 0-2.25zM10.875 2a1.125 1.125 0 0 1 2.25 0v4.875h8.263l.116.006a1.125 1.125 0 0 1 0 2.238l-.116.006H2.612a1.125 1.125 0 0 1 0-2.25h8.263z"
      />
      <path
        fill={color}
