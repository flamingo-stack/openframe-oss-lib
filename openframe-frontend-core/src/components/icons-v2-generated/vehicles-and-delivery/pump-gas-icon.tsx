...
export interface PumpGasIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function PumpGasIcon({ className = '', size = 24, color = 'currentColor', ...props }: PumpGasIconProps) {
  return (
    <svg
