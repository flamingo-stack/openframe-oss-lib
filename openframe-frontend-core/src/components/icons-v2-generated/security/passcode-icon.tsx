...
export interface PasscodeIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function PasscodeIcon({ className = '', size = 24, color = 'currentColor', ...props }: PasscodeIconProps) {
  return (
    <svg
