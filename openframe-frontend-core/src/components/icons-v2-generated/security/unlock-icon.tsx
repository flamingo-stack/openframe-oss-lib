...
export interface UnlockIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function UnlockIcon({ className = '', size = 24, color = 'currentColor', ...props }: UnlockIconProps) {
  return (
    <svg
