...
export interface ShieldLockIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function ShieldLockIcon({ className = '', size = 24, color = 'currentColor', ...props }: ShieldLockIconProps) {
  return (
    <svg
    ...
    >
      ...
      <path
        fill={color}
        d="M10.125 14.374h3.75v-1.748h-3.75zm2.5-5.124a.626.626 0 0 0-1.25 0v1.126h1.25zm2.25 1.315a2.12 2.12 0 0 1 1.25 1.934v2.002a2.125 2.125 0 0 1-2.126 2.124h-3.998A2.125 2.125 0 0 1 7.875 14.5v-2.002c0-.86.513-1.6 1.25-1.934V9.25a2.876 2.876 0 0 1 5.75 0z"
      />
    </svg>
  );
}
