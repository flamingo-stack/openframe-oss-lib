...
export interface LockCheckIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function LockCheckIcon({ className = '', size = 24, color = 'currentColor', ...props }: LockCheckIconProps) {
  return (
    <svg
