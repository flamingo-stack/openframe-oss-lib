...
export interface ScanIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function ScanIcon({ className = '', size = 24, color = 'currentColor', ...props }: ScanIconProps) {
  return (
    <svg
