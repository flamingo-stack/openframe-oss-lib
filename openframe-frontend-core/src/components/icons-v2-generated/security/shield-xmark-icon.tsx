...
export interface ShieldXmarkIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function ShieldXmarkIcon({ className = '', size = 24, color = 'currentColor', ...props }: ShieldXmarkIconProps) {
  return (
    <svg
    ...
    >
      ...
      <path
        fill={color}
        d="M13.704 8.705a1.125 1.125 0 0 1 1.59 1.59L13.59 12l1.705 1.705.078.086a1.124 1.124 0 0 1-1.582 1.583l-.087-.078L12 13.59l-1.704 1.705a1.125 1.125 0 1 1-1.59-1.59l1.703-1.706-1.703-1.704-.078-.085a1.126 1.126 0 0 1 1.583-1.583l.085.078L12 10.408z"
      />
    </svg>
  );
}
