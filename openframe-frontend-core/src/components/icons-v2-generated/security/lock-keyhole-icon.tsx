...
export interface LockKeyholeIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function LockKeyholeIcon({ className = '', size = 24, color = 'currentColor', ...props }: LockKeyholeIconProps) {
  return (
    <svg
