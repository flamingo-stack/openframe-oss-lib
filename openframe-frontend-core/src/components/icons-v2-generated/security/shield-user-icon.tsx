...
export interface ShieldUserIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function ShieldUserIcon({ className = '', size = 24, color = 'currentColor', ...props }: ShieldUserIconProps) {
  return (
    <svg
    ...
    >
      ...
      <path
        fill={color}
        d="M14.124 15.5c0-.76-.614-1.375-1.373-1.376h-1.5c-.76 0-1.376.617-1.376 1.376a1.125 1.125 0 0 1-2.25 0 3.626 3.626 0 0 1 3.626-3.626h1.5a3.625 3.625 0 0 1 3.624 3.626 1.125 1.125 0 0 1-2.25 0Zm-1.373-7.125a.75.75 0 1 0-1.501.001.75.75 0 0 0 1.5-.001Zm2.25 0a3 3 0 1 1-6.001 0 3 3 0 0 1 6 0Z"
      />
    </svg>
  );
}
