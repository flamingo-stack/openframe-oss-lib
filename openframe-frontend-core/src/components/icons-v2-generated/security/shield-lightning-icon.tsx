...
export interface ShieldLightningIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function ShieldLightningIcon({
  ...
  return (
    ...
    >
      ...
      <path
        fill={color}
        d="M13.006 16.503a1.124 1.124 0 0 1-2.013-1.006zm-2.013-9.005a1.125 1.125 0 1 1 2.013 1.005l-1.187 2.373H14a1.125 1.125 0 0 1 1.007 1.627l-2.001 4L11.999 16l-1.006-.502 1.187-2.371H10a1.125 1.125 0 0 1-1.006-1.63z"
      />
    </svg>
  );
}
