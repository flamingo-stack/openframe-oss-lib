...
export interface LockSquareIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function LockSquareIcon({ className = '', size = 24, color = 'currentColor', ...props }: LockSquareIconProps) {
  return (
    <svg
