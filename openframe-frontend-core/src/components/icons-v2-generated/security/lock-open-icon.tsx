...
export interface LockOpenIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function LockOpenIcon({ className = '', size = 24, color = 'currentColor', ...props }: LockOpenIconProps) {
  return (
    <svg
