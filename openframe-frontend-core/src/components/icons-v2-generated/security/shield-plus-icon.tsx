...
export interface ShieldPlusIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function ShieldPlusIcon({ className = '', size = 24, color = 'currentColor', ...props }: ShieldPlusIconProps) {
  return (
    <svg
    ...
    >
      ...
      <path
        fill={color}
        d="M10.875 15v-1.875H9a1.125 1.125 0 0 1 0-2.25h1.875V9a1.125 1.125 0 0 1 2.25 0v1.875H15a1.125 1.125 0 0 1 0 2.25h-1.875V15a1.125 1.125 0 0 1-2.25 0"
      />
    </svg>
  );
}
