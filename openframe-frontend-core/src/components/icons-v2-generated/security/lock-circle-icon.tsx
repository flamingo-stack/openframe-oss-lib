...
export interface LockCircleIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function LockCircleIcon({ className = '', size = 24, color = 'currentColor', ...props }: LockCircleIconProps) {
  return (
    <svg
