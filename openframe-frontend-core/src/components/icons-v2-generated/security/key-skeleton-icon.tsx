...
export interface KeySkeletonIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function KeySkeletonIcon({ className = '', size = 24, color = 'currentColor', ...props }: KeySkeletonIconProps) {
  return (
    <svg
