...
export interface ShieldMinusIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function ShieldMinusIcon({ className = '', size = 24, color = 'currentColor', ...props }: ShieldMinusIconProps) {
  return (
    <svg
    ...
    >
      ...
      />
      <path fill={color} d="M15 10.875a1.125 1.125 0 0 1 0 2.25H9a1.125 1.125 0 0 1 0-2.25z" />
    </svg>
  );
}
