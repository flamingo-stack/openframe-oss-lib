...
export interface ShieldCheckIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function ShieldCheckIcon({ className = '', size = 24, color = 'currentColor', ...props }: ShieldCheckIconProps) {
  return (
    <svg
