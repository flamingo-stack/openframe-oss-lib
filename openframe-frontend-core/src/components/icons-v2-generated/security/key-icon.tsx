...
export interface KeyIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function KeyIcon({ className = '', size = 24, color = 'currentColor', ...props }: KeyIconProps) {
  return (
    <svg
