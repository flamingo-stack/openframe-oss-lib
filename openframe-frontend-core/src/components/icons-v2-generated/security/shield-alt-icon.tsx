...
export interface ShieldAltIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function ShieldAltIcon({ className = '', size = 24, color = 'currentColor', ...props }: ShieldAltIconProps) {
  return (
    <svg
