...
export interface Number8IconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function Number8Icon({ className = '', size = 24, color = 'currentColor', ...props }: Number8IconProps) {
  return (
    <svg
