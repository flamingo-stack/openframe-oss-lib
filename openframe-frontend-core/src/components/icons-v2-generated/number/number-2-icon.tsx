...
export interface Number2IconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function Number2Icon({ className = '', size = 24, color = 'currentColor', ...props }: Number2IconProps) {
  return (
    <svg
