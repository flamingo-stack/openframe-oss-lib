...
export interface AgeLimit18IconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function AgeLimit18Icon({ className = '', size = 24, color = 'currentColor', ...props }: AgeLimit18IconProps) {
  return (
    <svg
