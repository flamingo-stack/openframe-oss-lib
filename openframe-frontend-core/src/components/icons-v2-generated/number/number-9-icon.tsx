...
export interface Number9IconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function Number9Icon({ className = '', size = 24, color = 'currentColor', ...props }: Number9IconProps) {
  return (
    <svg
