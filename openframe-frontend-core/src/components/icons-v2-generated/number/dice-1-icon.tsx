...
export interface Dice1IconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function Dice1Icon({ className = '', size = 24, color = 'currentColor', ...props }: Dice1IconProps) {
  return (
    <svg
