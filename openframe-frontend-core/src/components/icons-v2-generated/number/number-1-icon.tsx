...
export interface Number1IconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function Number1Icon({ className = '', size = 24, color = 'currentColor', ...props }: Number1IconProps) {
  return (
    <svg
