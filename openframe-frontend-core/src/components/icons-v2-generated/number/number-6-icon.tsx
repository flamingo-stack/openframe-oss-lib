...
export interface Number6IconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function Number6Icon({ className = '', size = 24, color = 'currentColor', ...props }: Number6IconProps) {
  return (
    <svg
