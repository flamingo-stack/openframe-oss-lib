...
export interface AgeLimit0IconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function AgeLimit0Icon({ className = '', size = 24, color = 'currentColor', ...props }: AgeLimit0IconProps) {
  return (
    <svg
