...
export interface AgeLimit3IconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function AgeLimit3Icon({ className = '', size = 24, color = 'currentColor', ...props }: AgeLimit3IconProps) {
  return (
    <svg
