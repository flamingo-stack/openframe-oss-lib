...
export interface Number5IconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function Number5Icon({ className = '', size = 24, color = 'currentColor', ...props }: Number5IconProps) {
  return (
    <svg
