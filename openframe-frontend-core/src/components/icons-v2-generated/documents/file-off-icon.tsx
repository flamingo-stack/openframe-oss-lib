...
export interface FileOffIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function FileOffIcon({ className = '', size = 24, color = 'currentColor', ...props }: FileOffIconProps) {
  return (
    <svg
