...
export interface StickerIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function StickerIcon({ className = '', size = 24, color = 'currentColor', ...props }: StickerIconProps) {
  return (
    <svg
