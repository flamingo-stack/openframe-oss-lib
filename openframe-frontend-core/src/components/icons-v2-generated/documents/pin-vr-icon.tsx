...
export interface PinVrIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function PinVrIcon({ className = '', size = 24, color = 'currentColor', ...props }: PinVrIconProps) {
  return (
    <svg
      ...
      {...props}
    >
      <path fill={color} d="M10.875 21v-4a1.125 1.125 0 1 1 2.25 0v4a1.125 1.125 0 0 1-2.25 0" />
      <path
        fill={color}
