...
export interface Paste01IconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function Paste01Icon({ className = '', size = 24, color = 'currentColor', ...props }: Paste01IconProps) {
  return (
    <svg
