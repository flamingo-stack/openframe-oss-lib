...
export interface FolderPlusIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function FolderPlusIcon({ className = '', size = 24, color = 'currentColor', ...props }: FolderPlusIconProps) {
  return (
    <svg
