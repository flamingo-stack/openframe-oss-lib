...
export interface FolderLockIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function FolderLockIcon({ className = '', size = 24, color = 'currentColor', ...props }: FolderLockIconProps) {
  return (
    <svg
