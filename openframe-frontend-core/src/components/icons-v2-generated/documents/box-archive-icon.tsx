...
export interface BoxArchiveIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function BoxArchiveIcon({ className = '', size = 24, color = 'currentColor', ...props }: BoxArchiveIconProps) {
  return (
    <svg
