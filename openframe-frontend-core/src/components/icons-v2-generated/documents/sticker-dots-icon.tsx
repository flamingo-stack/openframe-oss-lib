...
export interface StickerDotsIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function StickerDotsIcon({ className = '', size = 24, color = 'currentColor', ...props }: StickerDotsIconProps) {
  return (
    <svg
