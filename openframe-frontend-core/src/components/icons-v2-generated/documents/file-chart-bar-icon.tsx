...
export interface FileChartBarIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function FileChartBarIcon({
  className = '',
  size = 24,
  color = 'currentColor',
  ...props
}: FileChartBarIconProps) {
  return (
    <svg
    ...
    >
      ...
      <path
        fill={color}
        d="M6.875 18v-2a1.125 1.125 0 0 1 2.25 0v2a1.125 1.125 0 0 1-2.25 0m4 0v-6a1.125 1.125 0 0 1 2.25 0v6a1.125 1.125 0 0 1-2.25 0m4 0v-4a1.126 1.126 0 0 1 2.25 0v4a1.125 1.125 0 0 1-2.25 0"
      />
    </svg>
  );
}
