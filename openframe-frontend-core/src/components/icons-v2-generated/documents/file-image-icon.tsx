...
export interface FileImageIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function FileImageIcon({ className = '', size = 24, color = 'currentColor', ...props }: FileImageIconProps) {
  return (
    <svg
    ...
    >
      ...
      />
      <path fill={color} d="M9.217 8.885a2.126 2.126 0 1 1-2.332 2.332l-.01-.216.01-.219A2.126 2.126 0 0 1 9 8.875z" />
    </svg>
  );
}
