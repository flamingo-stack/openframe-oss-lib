...
export interface FolderEditIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function FolderEditIcon({ className = '', size = 24, color = 'currentColor', ...props }: FolderEditIconProps) {
  return (
    <svg
