...
export interface Copy01IconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function Copy01Icon({ className = '', size = 24, color = 'currentColor', ...props }: Copy01IconProps) {
  return (
    <svg
