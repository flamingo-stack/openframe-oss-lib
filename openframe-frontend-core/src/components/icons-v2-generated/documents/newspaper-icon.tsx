...
export interface NewspaperIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function NewspaperIcon({ className = '', size = 24, color = 'currentColor', ...props }: NewspaperIconProps) {
  return (
    <svg
