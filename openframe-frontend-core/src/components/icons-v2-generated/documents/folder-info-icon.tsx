...
export interface FolderInfoIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function FolderInfoIcon({ className = '', size = 24, color = 'currentColor', ...props }: FolderInfoIconProps) {
  return (
    <svg
