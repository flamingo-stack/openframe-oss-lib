...
export interface FileInfoIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function FileInfoIcon({ className = '', size = 24, color = 'currentColor', ...props }: FileInfoIconProps) {
  return (
    <svg
