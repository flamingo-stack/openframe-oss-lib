...
export interface FolderImageIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function FolderImageIcon({ className = '', size = 24, color = 'currentColor', ...props }: FolderImageIconProps) {
  return (
    <svg
    ...
    >
      ...
      />
      <path fill={color} d="M9.217 7.885a2.126 2.126 0 1 1-2.332 2.332l-.01-.216.01-.219A2.126 2.126 0 0 1 9 7.875z" />
    </svg>
  );
}
