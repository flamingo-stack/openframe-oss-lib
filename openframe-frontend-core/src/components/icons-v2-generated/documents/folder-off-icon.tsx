...
export interface FolderOffIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function FolderOffIcon({ className = '', size = 24, color = 'currentColor', ...props }: FolderOffIconProps) {
  return (
    <svg
