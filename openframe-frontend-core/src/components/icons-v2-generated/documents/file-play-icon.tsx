...
export interface FilePlayIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function FilePlayIcon({ className = '', size = 24, color = 'currentColor', ...props }: FilePlayIconProps) {
  return (
    <svg
