...
export interface FileSearchIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function FileSearchIcon({ className = '', size = 24, color = 'currentColor', ...props }: FileSearchIconProps) {
  return (
    <svg
    ...
    >
      ...
      <path
        fill={color}
        d="M13.875 14a1.875 1.875 0 1 0-3.75 0 1.875 1.875 0 0 0 3.75 0m2.25 0c0 .73-.192 1.415-.524 2.01l1.195 1.195.076.085a1.125 1.125 0 0 1-1.582 1.582l-.085-.076L14.01 17.6a4.125 4.125 0 1 1 2.115-3.6"
      />
    </svg>
  );
}
