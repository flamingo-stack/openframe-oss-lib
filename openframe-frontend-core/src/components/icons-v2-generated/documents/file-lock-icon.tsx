...
export interface FileLockIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function FileLockIcon({ className = '', size = 24, color = 'currentColor', ...props }: FileLockIconProps) {
  return (
    <svg
