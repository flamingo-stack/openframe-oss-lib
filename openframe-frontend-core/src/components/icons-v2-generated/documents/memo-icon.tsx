...
export interface MemoIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function MemoIcon({ className = '', size = 24, color = 'currentColor', ...props }: MemoIconProps) {
  return (
    <svg
