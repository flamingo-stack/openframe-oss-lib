...
export interface FileShieldIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function FileShieldIcon({ className = '', size = 24, color = 'currentColor', ...props }: FileShieldIconProps) {
  return (
    <svg
