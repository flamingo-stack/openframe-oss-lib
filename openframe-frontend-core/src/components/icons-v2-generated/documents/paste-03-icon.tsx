...
export interface Paste03IconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function Paste03Icon({ className = '', size = 24, color = 'currentColor', ...props }: Paste03IconProps) {
  return (
    <svg
