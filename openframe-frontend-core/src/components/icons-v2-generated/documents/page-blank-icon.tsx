...
export interface PageBlankIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function PageBlankIcon({ className = '', size = 24, color = 'currentColor', ...props }: PageBlankIconProps) {
  return (
    <svg
