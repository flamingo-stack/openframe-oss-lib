...
export interface FileCodeIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function FileCodeIcon({ className = '', size = 24, color = 'currentColor', ...props }: FileCodeIconProps) {
  return (
    <svg
