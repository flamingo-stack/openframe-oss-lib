...
export interface FolderMinusIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function FolderMinusIcon({ className = '', size = 24, color = 'currentColor', ...props }: FolderMinusIconProps) {
  return (
    <svg
    ...
    >
      ...
      />
      <path fill={color} d="M15 12.375a1.125 1.125 0 0 1 0 2.25H9a1.125 1.125 0 0 1 0-2.25z" />
    </svg>
  );
}
