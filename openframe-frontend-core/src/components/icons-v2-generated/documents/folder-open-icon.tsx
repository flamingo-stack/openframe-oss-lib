...
export interface FolderOpenIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function FolderOpenIcon({ className = '', size = 24, color = 'currentColor', ...props }: FolderOpenIconProps) {
  return (
    <svg
