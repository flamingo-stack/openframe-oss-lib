...
export interface FileBannedIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function FileBannedIcon({ className = '', size = 24, color = 'currentColor', ...props }: FileBannedIconProps) {
  return (
    <svg
