...
export interface FoldersIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function FoldersIcon({ className = '', size = 24, color = 'currentColor', ...props }: FoldersIconProps) {
  return (
    <svg
