...
export interface FileMinusIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function FileMinusIcon({ className = '', size = 24, color = 'currentColor', ...props }: FileMinusIconProps) {
  return (
    <svg
    ...
    >
      ...
      />
      <path fill={color} d="M15 13.875a1.125 1.125 0 0 1 0 2.25H9a1.125 1.125 0 0 1 0-2.25z" />
    </svg>
  );
}
