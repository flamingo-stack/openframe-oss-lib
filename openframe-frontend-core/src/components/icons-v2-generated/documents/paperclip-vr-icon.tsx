...
export interface PaperclipVrIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function PaperclipVrIcon({ className = '', size = 24, color = 'currentColor', ...props }: PaperclipVrIconProps) {
  return (
    <svg
