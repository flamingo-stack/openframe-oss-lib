...
export interface FileUserIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function FileUserIcon({ className = '', size = 24, color = 'currentColor', ...props }: FileUserIconProps) {
  return (
    <svg
