...
export interface AtmCardIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function AtmCardIcon({ className = '', size = 24, color = 'currentColor', ...props }: AtmCardIconProps) {
  return (
    <svg
