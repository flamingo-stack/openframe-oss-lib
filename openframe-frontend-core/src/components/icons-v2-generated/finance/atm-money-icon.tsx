...
export interface AtmMoneyIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function AtmMoneyIcon({ className = '', size = 24, color = 'currentColor', ...props }: AtmMoneyIconProps) {
  return (
    <svg
