...
export interface BankIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function BankIcon({ className = '', size = 24, color = 'currentColor', ...props }: BankIconProps) {
  return (
    <svg
