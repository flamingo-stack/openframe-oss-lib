...
export interface MoneyBillIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function MoneyBillIcon({ className = '', size = 24, color = 'currentColor', ...props }: MoneyBillIconProps) {
  return (
    <svg
