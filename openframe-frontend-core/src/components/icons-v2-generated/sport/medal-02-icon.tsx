...
export interface Medal02IconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function Medal02Icon({ className = '', size = 24, color = 'currentColor', ...props }: Medal02IconProps) {
  return (
    <svg
