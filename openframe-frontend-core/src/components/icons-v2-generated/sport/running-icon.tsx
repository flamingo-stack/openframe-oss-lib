...
export interface RunningIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function RunningIcon({ className = '', size = 24, color = 'currentColor', ...props }: RunningIconProps) {
  return (
    <svg
