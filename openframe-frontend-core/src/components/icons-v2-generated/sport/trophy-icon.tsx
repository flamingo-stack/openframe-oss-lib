...
export interface TrophyIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function TrophyIcon({ className = '', size = 24, color = 'currentColor', ...props }: TrophyIconProps) {
  return (
    <svg
