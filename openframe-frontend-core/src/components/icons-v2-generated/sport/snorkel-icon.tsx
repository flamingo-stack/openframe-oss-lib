...
export interface SnorkelIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function SnorkelIcon({ className = '', size = 24, color = 'currentColor', ...props }: SnorkelIconProps) {
  return (
    <svg
