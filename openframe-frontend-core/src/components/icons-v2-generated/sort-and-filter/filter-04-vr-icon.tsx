...
export interface Filter04VrIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function Filter04VrIcon({ className = '', size = 24, color = 'currentColor', ...props }: Filter04VrIconProps) {
  return (
    <svg
