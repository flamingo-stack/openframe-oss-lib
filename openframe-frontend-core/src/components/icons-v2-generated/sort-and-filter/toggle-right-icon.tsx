...
export interface ToggleRightIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function ToggleRightIcon({ className = '', size = 24, color = 'currentColor', ...props }: ToggleRightIconProps) {
  return (
    <svg
