...
export interface SortZaDownIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function SortZaDownIcon({ className = '', size = 24, color = 'currentColor', ...props }: SortZaDownIconProps) {
  return (
    <svg
