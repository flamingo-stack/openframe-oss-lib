...
export interface TogglesIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function TogglesIcon({ className = '', size = 24, color = 'currentColor', ...props }: TogglesIconProps) {
  return (
    <svg
