...
export interface Filter03HrIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function Filter03HrIcon({ className = '', size = 24, color = 'currentColor', ...props }: Filter03HrIconProps) {
  return (
    <svg
