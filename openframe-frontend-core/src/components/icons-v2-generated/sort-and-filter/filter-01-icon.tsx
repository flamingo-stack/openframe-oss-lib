...
export interface Filter01IconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function Filter01Icon({ className = '', size = 24, color = 'currentColor', ...props }: Filter01IconProps) {
  return (
    <svg
