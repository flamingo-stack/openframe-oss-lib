...
export interface Sort91UpIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function Sort91UpIcon({ className = '', size = 24, color = 'currentColor', ...props }: Sort91UpIconProps) {
  return (
    <svg
