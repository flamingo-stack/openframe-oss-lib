...
export interface Sort19DownIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function Sort19DownIcon({ className = '', size = 24, color = 'currentColor', ...props }: Sort19DownIconProps) {
  return (
    <svg
