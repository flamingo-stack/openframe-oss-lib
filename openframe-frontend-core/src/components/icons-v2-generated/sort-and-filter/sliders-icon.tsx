...
export interface SlidersIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function SlidersIcon({ className = '', size = 24, color = 'currentColor', ...props }: SlidersIconProps) {
  return (
    <svg
