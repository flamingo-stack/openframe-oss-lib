...
export interface Filter02IconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function Filter02Icon({ className = '', size = 24, color = 'currentColor', ...props }: Filter02IconProps) {
  return (
    <svg
