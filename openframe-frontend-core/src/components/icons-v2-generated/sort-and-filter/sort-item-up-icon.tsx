...
export interface SortItemUpIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function SortItemUpIcon({ className = '', size = 24, color = 'currentColor', ...props }: SortItemUpIconProps) {
  return (
    <svg
