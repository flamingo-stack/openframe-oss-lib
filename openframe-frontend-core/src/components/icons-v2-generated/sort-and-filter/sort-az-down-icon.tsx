...
export interface SortAzDownIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function SortAzDownIcon({ className = '', size = 24, color = 'currentColor', ...props }: SortAzDownIconProps) {
  return (
    <svg
