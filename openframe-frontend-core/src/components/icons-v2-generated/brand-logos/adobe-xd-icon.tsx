...
export interface AdobeXdIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function AdobeXdIcon({ className = '', size = 24, color = 'currentColor', ...props }: AdobeXdIconProps) {
  return (
    <svg
