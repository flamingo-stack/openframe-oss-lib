...
export interface TiktokIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function TiktokIcon({ className = '', size = 24, color = 'currentColor', ...props }: TiktokIconProps) {
  return (
    <svg
