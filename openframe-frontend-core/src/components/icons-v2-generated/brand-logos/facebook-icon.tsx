...
export interface FacebookIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function FacebookIcon({ className = '', size = 24, color = 'currentColor', ...props }: FacebookIconProps) {
  return (
    <svg
