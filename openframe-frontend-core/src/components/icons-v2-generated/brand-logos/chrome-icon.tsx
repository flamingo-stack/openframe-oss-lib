...
export interface ChromeIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function ChromeIcon({ className = '', size = 24, color = 'currentColor', ...props }: ChromeIconProps) {
  return (
    <svg
