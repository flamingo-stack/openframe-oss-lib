...
export interface FigmaIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function FigmaIcon({ className = '', size = 24, color = 'currentColor', ...props }: FigmaIconProps) {
  return (
    <svg
