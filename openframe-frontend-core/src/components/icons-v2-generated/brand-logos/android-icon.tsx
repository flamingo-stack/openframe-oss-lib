...
export interface AndroidIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function AndroidIcon({ className = '', size = 24, color = 'currentColor', ...props }: AndroidIconProps) {
  return (
    <svg
