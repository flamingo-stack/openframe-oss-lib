...
export interface GithubLogoIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function GithubLogoIcon({ className = '', size = 24, color = 'currentColor', ...props }: GithubLogoIconProps) {
  return (
    <svg
