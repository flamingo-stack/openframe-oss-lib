...
export interface PinterestIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function PinterestIcon({ className = '', size = 24, color = 'currentColor', ...props }: PinterestIconProps) {
  return (
    <svg
