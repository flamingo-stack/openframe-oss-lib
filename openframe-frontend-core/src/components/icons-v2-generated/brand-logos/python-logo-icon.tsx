...
export interface PythonLogoIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function PythonLogoIcon({ className = '', size = 24, color = 'currentColor', ...props }: PythonLogoIconProps) {
  return (
    <svg
