...
export interface PaypalIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function PaypalIcon({ className = '', size = 24, color = 'currentColor', ...props }: PaypalIconProps) {
  return (
    <svg
