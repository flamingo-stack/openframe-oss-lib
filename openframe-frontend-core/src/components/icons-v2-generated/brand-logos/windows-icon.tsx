...
export interface WindowsIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function WindowsIcon({ className = '', size = 24, color = 'currentColor', ...props }: WindowsIconProps) {
  return (
    <svg
