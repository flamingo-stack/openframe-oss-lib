...
export interface TrelloIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function TrelloIcon({ className = '', size = 24, color = 'currentColor', ...props }: TrelloIconProps) {
  return (
    <svg
