...
export interface GoogleDriveIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function GoogleDriveIcon({ className = '', size = 24, color = 'currentColor', ...props }: GoogleDriveIconProps) {
  return (
    <svg
