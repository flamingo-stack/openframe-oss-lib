...
export interface DribbbleIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function DribbbleIcon({ className = '', size = 24, color = 'currentColor', ...props }: DribbbleIconProps) {
  return (
    <svg
