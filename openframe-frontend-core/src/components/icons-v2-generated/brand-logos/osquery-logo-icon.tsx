...
export interface OsqueryLogoIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function OsqueryLogoIcon({ className = '', size = 24, color = 'currentColor', ...props }: OsqueryLogoIconProps) {
  return (
    <svg
