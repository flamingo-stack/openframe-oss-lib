...
export interface BehanceIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function BehanceIcon({ className = '', size = 24, color = 'currentColor', ...props }: BehanceIconProps) {
  return (
    <svg
