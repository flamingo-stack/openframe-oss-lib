...
export interface AdobeIdIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function AdobeIdIcon({ className = '', size = 24, color = 'currentColor', ...props }: AdobeIdIconProps) {
  return (
    <svg
