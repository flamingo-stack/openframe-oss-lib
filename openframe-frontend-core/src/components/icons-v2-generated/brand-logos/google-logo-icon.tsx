...
export interface GoogleLogoIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function GoogleLogoIcon({ className = '', size = 24, color = 'currentColor', ...props }: GoogleLogoIconProps) {
  return (
    <svg
