...
export interface AdobeAeIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function AdobeAeIcon({ className = '', size = 24, color = 'currentColor', ...props }: AdobeAeIconProps) {
  return (
    <svg
