...
export interface AppStoreIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function AppStoreIcon({ className = '', size = 24, color = 'currentColor', ...props }: AppStoreIconProps) {
  return (
    <svg
