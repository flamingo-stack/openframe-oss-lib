...
export interface InstagramIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function InstagramIcon({ className = '', size = 24, color = 'currentColor', ...props }: InstagramIconProps) {
  return (
    <svg
