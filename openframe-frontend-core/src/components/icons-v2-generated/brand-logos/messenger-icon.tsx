...
export interface MessengerIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function MessengerIcon({ className = '', size = 24, color = 'currentColor', ...props }: MessengerIconProps) {
  return (
    <svg
