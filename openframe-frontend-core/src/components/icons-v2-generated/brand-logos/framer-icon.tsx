...
export interface FramerIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function FramerIcon({ className = '', size = 24, color = 'currentColor', ...props }: FramerIconProps) {
  return (
    <svg
