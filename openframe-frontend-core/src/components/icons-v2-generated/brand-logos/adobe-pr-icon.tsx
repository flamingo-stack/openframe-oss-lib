...
export interface AdobePrIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function AdobePrIcon({ className = '', size = 24, color = 'currentColor', ...props }: AdobePrIconProps) {
  return (
    <svg
