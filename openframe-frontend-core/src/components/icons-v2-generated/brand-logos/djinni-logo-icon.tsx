...
export interface DjinniLogoIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function DjinniLogoIcon({ className = '', size = 24, color = 'currentColor', ...props }: DjinniLogoIconProps) {
  return (
    <svg
