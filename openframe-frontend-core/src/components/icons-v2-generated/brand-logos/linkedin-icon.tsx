...
export interface LinkedinIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function LinkedinIcon({ className = '', size = 24, color = 'currentColor', ...props }: LinkedinIconProps) {
  return (
    <svg
