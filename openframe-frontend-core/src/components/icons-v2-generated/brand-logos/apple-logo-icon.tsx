...
export interface AppleLogoIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function AppleLogoIcon({ className = '', size = 24, color = 'currentColor', ...props }: AppleLogoIconProps) {
  return (
    <svg
