...
export interface GooglePlayIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function GooglePlayIcon({ className = '', size = 24, color = 'currentColor', ...props }: GooglePlayIconProps) {
  return (
    <svg
