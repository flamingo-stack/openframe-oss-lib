...
export interface SlackLogoIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function SlackLogoIcon({ className = '', size = 24, color = 'currentColor', ...props }: SlackLogoIconProps) {
  return (
    <svg
