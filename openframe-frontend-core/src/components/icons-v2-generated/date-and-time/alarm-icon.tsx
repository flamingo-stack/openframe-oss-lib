...
export interface AlarmIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function AlarmIcon({ className = '', size = 24, color = 'currentColor', ...props }: AlarmIconProps) {
  return (
    <svg
