...
export interface AlarmCheckIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function AlarmCheckIcon({ className = '', size = 24, color = 'currentColor', ...props }: AlarmCheckIconProps) {
  return (
    <svg
    ...
    >
      ...
      <path
        fill={color}
        d="M19.875 13a7.875 7.875 0 1 0-15.75 0 7.875 7.875 0 0 0 15.75 0m-5.17-3.296a1.125 1.125 0 0 1 1.59 1.591l-4.5 4.5c-.44.44-1.152.44-1.59 0l-2-2-.078-.085a1.126 1.126 0 0 1 1.583-1.583l.085.078L11 13.409zM22.124 13c0 5.592-4.533 10.125-10.125 10.125S1.875 18.592 1.875 13 6.408 2.875 12 2.875 22.125 7.408 22.125 13Z"
      />
    </svg>
  );
}
