...
export interface CalendarDayIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function CalendarDayIcon({ className = '', size = 24, color = 'currentColor', ...props }: CalendarDayIconProps) {
  return (
    <svg
