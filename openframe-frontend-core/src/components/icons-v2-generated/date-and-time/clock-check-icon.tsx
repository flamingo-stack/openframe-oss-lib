...
export interface ClockCheckIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function ClockCheckIcon({ className = '', size = 24, color = 'currentColor', ...props }: ClockCheckIconProps) {
  return (
    <svg
