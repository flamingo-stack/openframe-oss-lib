...
export interface AlarmPlusIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function AlarmPlusIcon({ className = '', size = 24, color = 'currentColor', ...props }: AlarmPlusIconProps) {
  return (
    <svg
    ...
    >
      ...
      <path
        fill={color}
        d="M19.875 13a7.875 7.875 0 1 0-15.75 0 7.875 7.875 0 0 0 15.75 0m-9 3v-1.875H9a1.125 1.125 0 1 1 0-2.25h1.875V10a1.125 1.125 0 0 1 2.25 0v1.875H15a1.125 1.125 0 0 1 0 2.25h-1.875V16a1.125 1.125 0 1 1-2.25 0m11.25-3c0 5.592-4.533 10.125-10.125 10.125S1.875 18.592 1.875 13 6.408 2.875 12 2.875 22.125 7.408 22.125 13"
      />
    </svg>
  );
}
