...
export interface ClockPlusIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function ClockPlusIcon({ className = '', size = 24, color = 'currentColor', ...props }: ClockPlusIconProps) {
  return (
    <svg
