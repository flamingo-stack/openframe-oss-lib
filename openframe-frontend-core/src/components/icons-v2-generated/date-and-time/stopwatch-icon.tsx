...
export interface StopwatchIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function StopwatchIcon({ className = '', size = 24, color = 'currentColor', ...props }: StopwatchIconProps) {
  return (
    <svg
