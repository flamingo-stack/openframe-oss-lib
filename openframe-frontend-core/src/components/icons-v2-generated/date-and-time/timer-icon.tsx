...
export interface TimerIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function TimerIcon({ className = '', size = 24, color = 'currentColor', ...props }: TimerIconProps) {
  return (
    <svg
