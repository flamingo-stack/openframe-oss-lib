...
export interface HourglassIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function HourglassIcon({ className = '', size = 24, color = 'currentColor', ...props }: HourglassIconProps) {
  return (
    <svg
