...
export interface BookPlayIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function BookPlayIcon({ className = '', size = 24, color = 'currentColor', ...props }: BookPlayIconProps) {
  return (
    <svg
    ...
    >
      ...
      <path
        fill={color}
        d="M8.644 6.896c.17-1.19 1.476-1.874 2.55-1.336l.227.134 3.843 2.663a2 2 0 0 1 0 3.287l-3.843 2.663c-1.18.818-2.796-.028-2.796-1.465V7.158zm2.231 5.05L13.685 10l-2.81-1.948z"
      />
    </svg>
  );
}
