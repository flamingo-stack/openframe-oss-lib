...
export interface RadioIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function RadioIcon({ className = '', size = 24, color = 'currentColor', ...props }: RadioIconProps) {
  return (
    <svg
