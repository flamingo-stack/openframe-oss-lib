...
export interface FilmVrIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function FilmVrIcon({ className = '', size = 24, color = 'currentColor', ...props }: FilmVrIconProps) {
  return (
    <svg
