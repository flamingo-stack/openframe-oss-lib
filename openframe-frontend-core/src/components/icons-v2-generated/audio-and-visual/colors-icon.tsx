...
export interface ColorsIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function ColorsIcon({ className = '', size = 24, color = 'currentColor', ...props }: ColorsIconProps) {
  return (
    <svg
