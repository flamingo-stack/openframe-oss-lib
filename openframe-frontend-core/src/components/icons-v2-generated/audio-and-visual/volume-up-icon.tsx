...
export interface VolumeUpIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function VolumeUpIcon({ className = '', size = 24, color = 'currentColor', ...props }: VolumeUpIconProps) {
  return (
    <svg
