...
export interface HeadsetIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function HeadsetIcon({ className = '', size = 24, color = 'currentColor', ...props }: HeadsetIconProps) {
  return (
    <svg
