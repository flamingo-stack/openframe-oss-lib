...
export interface VolumeDownIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function VolumeDownIcon({ className = '', size = 24, color = 'currentColor', ...props }: VolumeDownIconProps) {
  return (
    <svg
