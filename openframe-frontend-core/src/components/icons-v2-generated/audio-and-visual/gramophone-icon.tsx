...
export interface GramophoneIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function GramophoneIcon({ className = '', size = 24, color = 'currentColor', ...props }: GramophoneIconProps) {
  return (
    <svg
