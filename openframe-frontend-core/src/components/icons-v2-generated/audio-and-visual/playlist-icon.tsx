...
export interface PlaylistIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function PlaylistIcon({ className = '', size = 24, color = 'currentColor', ...props }: PlaylistIconProps) {
  return (
    <svg
