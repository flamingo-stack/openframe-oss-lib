...
export interface LightningIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function LightningIcon({ className = '', size = 24, color = 'currentColor', ...props }: LightningIconProps) {
  return (
    <svg
