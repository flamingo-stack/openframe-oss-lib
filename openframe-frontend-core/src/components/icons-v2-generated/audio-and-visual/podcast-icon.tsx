...
export interface PodcastIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function PodcastIcon({ className = '', size = 24, color = 'currentColor', ...props }: PodcastIconProps) {
  return (
    <svg
