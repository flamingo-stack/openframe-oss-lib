...
export interface Hand2FingerIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function Hand2FingerIcon({ className = '', size = 24, color = 'currentColor', ...props }: Hand2FingerIconProps) {
  return (
    <svg
