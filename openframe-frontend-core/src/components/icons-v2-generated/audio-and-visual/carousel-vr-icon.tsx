...
export interface CarouselVrIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function CarouselVrIcon({ className = '', size = 24, color = 'currentColor', ...props }: CarouselVrIconProps) {
  return (
    <svg
