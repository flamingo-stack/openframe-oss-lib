...
export interface ImageOffIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function ImageOffIcon({ className = '', size = 24, color = 'currentColor', ...props }: ImageOffIconProps) {
  return (
    <svg
