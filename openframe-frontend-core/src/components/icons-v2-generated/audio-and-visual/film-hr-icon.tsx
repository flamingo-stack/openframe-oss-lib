...
export interface FilmHrIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function FilmHrIcon({ className = '', size = 24, color = 'currentColor', ...props }: FilmHrIconProps) {
  return (
    <svg
