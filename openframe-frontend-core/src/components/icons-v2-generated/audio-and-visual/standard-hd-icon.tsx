...
export interface StandardHdIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function StandardHdIcon({ className = '', size = 24, color = 'currentColor', ...props }: StandardHdIconProps) {
  return (
    <svg
