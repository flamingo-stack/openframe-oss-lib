...
export interface CameraIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function CameraIcon({ className = '', size = 24, color = 'currentColor', ...props }: CameraIconProps) {
  return (
    <svg
