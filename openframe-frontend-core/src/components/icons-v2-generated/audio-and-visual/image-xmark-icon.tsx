...
export interface ImageXmarkIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function ImageXmarkIcon({ className = '', size = 24, color = 'currentColor', ...props }: ImageXmarkIconProps) {
  return (
    <svg
