...
export interface PhotoFilterIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function PhotoFilterIcon({ className = '', size = 24, color = 'currentColor', ...props }: PhotoFilterIconProps) {
  return (
    <svg
