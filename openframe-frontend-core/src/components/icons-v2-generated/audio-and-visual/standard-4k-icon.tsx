...
export interface Standard4kIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function Standard4kIcon({ className = '', size = 24, color = 'currentColor', ...props }: Standard4kIconProps) {
  return (
    <svg
