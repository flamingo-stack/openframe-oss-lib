...
export interface MovieIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function MovieIcon({ className = '', size = 24, color = 'currentColor', ...props }: MovieIconProps) {
  return (
    <svg
