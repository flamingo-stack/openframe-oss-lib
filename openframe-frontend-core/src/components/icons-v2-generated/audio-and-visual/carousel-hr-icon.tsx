...
export interface CarouselHrIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function CarouselHrIcon({ className = '', size = 24, color = 'currentColor', ...props }: CarouselHrIconProps) {
  return (
    <svg
