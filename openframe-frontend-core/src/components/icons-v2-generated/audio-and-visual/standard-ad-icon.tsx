...
export interface StandardAdIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function StandardAdIcon({ className = '', size = 24, color = 'currentColor', ...props }: StandardAdIconProps) {
  return (
    <svg
