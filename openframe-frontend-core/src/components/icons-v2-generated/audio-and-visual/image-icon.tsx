...
export interface ImageIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function ImageIcon({ className = '', size = 24, color = 'currentColor', ...props }: ImageIconProps) {
  return (
    <svg
