...
export interface ApertureIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function ApertureIcon({ className = '', size = 24, color = 'currentColor', ...props }: ApertureIconProps) {
  return (
    <svg
