...
export interface Hand1FingerIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function Hand1FingerIcon({ className = '', size = 24, color = 'currentColor', ...props }: Hand1FingerIconProps) {
  return (
    <svg
