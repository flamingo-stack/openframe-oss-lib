...
export interface StandardArIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function StandardArIcon({ className = '', size = 24, color = 'currentColor', ...props }: StandardArIconProps) {
  return (
    <svg
