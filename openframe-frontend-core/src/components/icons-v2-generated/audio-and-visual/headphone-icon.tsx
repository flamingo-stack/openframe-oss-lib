...
export interface HeadphoneIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function HeadphoneIcon({ className = '', size = 24, color = 'currentColor', ...props }: HeadphoneIconProps) {
  return (
    <svg
