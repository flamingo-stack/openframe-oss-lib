...
export interface MusicNote01IconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function MusicNote01Icon({ className = '', size = 24, color = 'currentColor', ...props }: MusicNote01IconProps) {
  return (
    <svg
