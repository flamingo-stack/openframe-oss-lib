...
export interface DiscVinylIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function DiscVinylIcon({ className = '', size = 24, color = 'currentColor', ...props }: DiscVinylIconProps) {
  return (
    <svg
