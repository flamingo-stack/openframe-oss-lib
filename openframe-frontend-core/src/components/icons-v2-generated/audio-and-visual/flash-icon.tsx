...
export interface FlashIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function FlashIcon({ className = '', size = 24, color = 'currentColor', ...props }: FlashIconProps) {
  return (
    <svg
