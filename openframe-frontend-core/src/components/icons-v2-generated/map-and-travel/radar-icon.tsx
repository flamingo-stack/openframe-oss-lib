...
export interface RadarIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function RadarIcon({ className = '', size = 24, color = 'currentColor', ...props }: RadarIconProps) {
  return (
    <svg
