...
export interface MapIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function MapIcon({ className = '', size = 24, color = 'currentColor', ...props }: MapIconProps) {
  return (
    <svg
