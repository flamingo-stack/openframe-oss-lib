...
export interface CompassIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function CompassIcon({ className = '', size = 24, color = 'currentColor', ...props }: CompassIconProps) {
  return (
    <svg
