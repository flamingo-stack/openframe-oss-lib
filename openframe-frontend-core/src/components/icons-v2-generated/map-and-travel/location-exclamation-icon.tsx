...
export interface LocationExclamationIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function LocationExclamationIcon({
  className = '',
  size = 24,
  color = 'currentColor',
  ...props
}: LocationExclamationIconProps) {
  return (
    <svg
    ...
    >
      ...
      <path
        fill={color}
        d="M10.876 11V7a1.125 1.125 0 0 1 2.25 0v4a1.126 1.126 0 0 1-2.25 0m2.498 4a1.375 1.375 0 0 1-2.742.14l-.007-.14.007-.141a1.375 1.375 0 0 1 1.369-1.233l.14.007c.693.07 1.233.655 1.233 1.367"
      />
    </svg>
  );
}
