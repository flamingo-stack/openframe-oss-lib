...
export interface LocationXmarkIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function LocationXmarkIcon({
  className = '',
  size = 24,
  color = 'currentColor',
  ...props
}: LocationXmarkIconProps) {
  return (
    <svg
    ...
    >
      ...
      <path
        fill={color}
        d="M13.704 7.705a1.125 1.125 0 0 1 1.59 1.59L13.59 11l1.705 1.705.078.086a1.124 1.124 0 0 1-1.582 1.583l-.087-.078L12 12.59l-1.704 1.705a1.125 1.125 0 1 1-1.59-1.59l1.703-1.706-1.703-1.704-.078-.085a1.125 1.125 0 0 1 1.583-1.583l.085.078L12 9.408z"
      />
    </svg>
  );
}
