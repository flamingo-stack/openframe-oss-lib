...
export interface Flag02IconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function Flag02Icon({ className = '', size = 24, color = 'currentColor', ...props }: Flag02IconProps) {
  return (
    <svg
