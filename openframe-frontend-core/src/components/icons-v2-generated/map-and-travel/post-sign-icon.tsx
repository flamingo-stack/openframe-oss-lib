...
export interface PostSignIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function PostSignIcon({ className = '', size = 24, color = 'currentColor', ...props }: PostSignIconProps) {
  return (
    <svg
