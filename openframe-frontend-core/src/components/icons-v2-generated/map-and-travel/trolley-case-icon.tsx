...
export interface TrolleyCaseIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function TrolleyCaseIcon({ className = '', size = 24, color = 'currentColor', ...props }: TrolleyCaseIconProps) {
  return (
    <svg
