...
export interface LocationCheckIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function LocationCheckIcon({
  ...
  return (
    ...
    >
      ...
      <path
        fill={color}
        d="M14.704 7.705a1.125 1.125 0 0 1 1.59 1.59l-4.5 4.5c-.438.44-1.15.44-1.59 0l-2-2-.077-.085a1.125 1.125 0 0 1 1.583-1.583l.085.078L11 11.41z"
      />
    </svg>
  );
}
