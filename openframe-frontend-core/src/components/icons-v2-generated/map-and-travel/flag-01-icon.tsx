...
export interface Flag01IconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function Flag01Icon({ className = '', size = 24, color = 'currentColor', ...props }: Flag01IconProps) {
  return (
    <svg
    ...
    >
      ...
      />
      <path fill={color} d="M2.875 22V2a1.125 1.125 0 0 1 2.25 0v20a1.125 1.125 0 0 1-2.25 0" />
    </svg>
  );
}
