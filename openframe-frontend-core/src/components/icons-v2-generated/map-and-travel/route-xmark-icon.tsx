...
export interface RouteXmarkIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function RouteXmarkIcon({ className = '', size = 24, color = 'currentColor', ...props }: RouteXmarkIconProps) {
  return (
    <svg
