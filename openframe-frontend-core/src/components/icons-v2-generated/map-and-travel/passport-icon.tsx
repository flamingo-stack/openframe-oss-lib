...
export interface PassportIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function PassportIcon({ className = '', size = 24, color = 'currentColor', ...props }: PassportIconProps) {
  return (
    <svg
