...
export interface BeachIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function BeachIcon({ className = '', size = 24, color = 'currentColor', ...props }: BeachIconProps) {
  return (
    <svg
