...
export interface Crosshair01IconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function Crosshair01Icon({ className = '', size = 24, color = 'currentColor', ...props }: Crosshair01IconProps) {
  return (
    <svg
