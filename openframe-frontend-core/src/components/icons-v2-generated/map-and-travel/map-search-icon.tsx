...
export interface MapSearchIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function MapSearchIcon({ className = '', size = 24, color = 'currentColor', ...props }: MapSearchIconProps) {
  return (
    <svg
