...
export interface MapSquareIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function MapSquareIcon({ className = '', size = 24, color = 'currentColor', ...props }: MapSquareIconProps) {
  return (
    <svg
