...
export interface SuitcaseIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function SuitcaseIcon({ className = '', size = 24, color = 'currentColor', ...props }: SuitcaseIconProps) {
  return (
    <svg
