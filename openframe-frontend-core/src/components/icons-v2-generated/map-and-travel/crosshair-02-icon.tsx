...
export interface Crosshair02IconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function Crosshair02Icon({ className = '', size = 24, color = 'currentColor', ...props }: Crosshair02IconProps) {
  return (
    <svg
