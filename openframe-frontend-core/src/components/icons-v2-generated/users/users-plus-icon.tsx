...
export interface UsersPlusIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function UsersPlusIcon({ className = '', size = 24, color = 'currentColor', ...props }: UsersPlusIconProps) {
  return (
    <svg
