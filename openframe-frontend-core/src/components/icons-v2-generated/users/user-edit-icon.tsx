...
export interface UserEditIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function UserEditIcon({ className = '', size = 24, color = 'currentColor', ...props }: UserEditIconProps) {
  return (
    <svg
