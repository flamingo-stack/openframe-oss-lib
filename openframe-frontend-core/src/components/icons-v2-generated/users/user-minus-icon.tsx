...
export interface UserMinusIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function UserMinusIcon({ className = '', size = 24, color = 'currentColor', ...props }: UserMinusIconProps) {
  return (
    <svg
