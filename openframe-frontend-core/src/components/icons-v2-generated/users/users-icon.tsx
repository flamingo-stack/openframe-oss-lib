...
export interface UsersIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function UsersIcon({ className = '', size = 24, color = 'currentColor', ...props }: UsersIconProps) {
  return (
    <svg
