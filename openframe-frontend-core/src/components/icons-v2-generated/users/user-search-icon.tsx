...
export interface UserSearchIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function UserSearchIcon({ className = '', size = 24, color = 'currentColor', ...props }: UserSearchIconProps) {
  return (
    <svg
