...
export interface UserBannedIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function UserBannedIcon({ className = '', size = 24, color = 'currentColor', ...props }: UserBannedIconProps) {
  return (
    <svg
