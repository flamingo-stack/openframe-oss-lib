...
export interface UserCheckIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function UserCheckIcon({ className = '', size = 24, color = 'currentColor', ...props }: UserCheckIconProps) {
  return (
    <svg
