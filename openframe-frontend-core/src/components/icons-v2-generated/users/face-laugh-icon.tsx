...
export interface FaceLaughIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function FaceLaughIcon({ className = '', size = 24, color = 'currentColor', ...props }: FaceLaughIconProps) {
  return (
    <svg
