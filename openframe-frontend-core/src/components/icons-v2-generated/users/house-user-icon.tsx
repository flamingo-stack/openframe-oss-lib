...
export interface HouseUserIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function HouseUserIcon({ className = '', size = 24, color = 'currentColor', ...props }: HouseUserIconProps) {
  return (
    <svg
