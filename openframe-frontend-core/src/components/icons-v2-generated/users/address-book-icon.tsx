...
export interface AddressBookIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function AddressBookIcon({ className = '', size = 24, color = 'currentColor', ...props }: AddressBookIconProps) {
  return (
    <svg
