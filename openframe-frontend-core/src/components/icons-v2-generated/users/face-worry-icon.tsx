...
export interface FaceWorryIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function FaceWorryIcon({ className = '', size = 24, color = 'currentColor', ...props }: FaceWorryIconProps) {
  return (
    <svg
