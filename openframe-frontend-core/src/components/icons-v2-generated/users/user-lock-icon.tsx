...
export interface UserLockIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function UserLockIcon({ className = '', size = 24, color = 'currentColor', ...props }: UserLockIconProps) {
  return (
    <svg
