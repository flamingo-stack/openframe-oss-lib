...
export interface UserPlusIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function UserPlusIcon({ className = '', size = 24, color = 'currentColor', ...props }: UserPlusIconProps) {
  return (
    <svg
