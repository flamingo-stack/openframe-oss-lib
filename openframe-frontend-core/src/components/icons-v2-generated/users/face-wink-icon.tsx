...
export interface FaceWinkIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function FaceWinkIcon({ className = '', size = 24, color = 'currentColor', ...props }: FaceWinkIconProps) {
  return (
    <svg
