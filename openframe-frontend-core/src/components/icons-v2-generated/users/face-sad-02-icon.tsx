...
export interface FaceSad02IconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function FaceSad02Icon({ className = '', size = 24, color = 'currentColor', ...props }: FaceSad02IconProps) {
  return (
    <svg
