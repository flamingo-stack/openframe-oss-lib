...
export interface IdCardIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function IdCardIcon({ className = '', size = 24, color = 'currentColor', ...props }: IdCardIconProps) {
  return (
    <svg
