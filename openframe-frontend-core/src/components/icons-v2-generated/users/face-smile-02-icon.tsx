...
export interface FaceSmile02IconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function FaceSmile02Icon({ className = '', size = 24, color = 'currentColor', ...props }: FaceSmile02IconProps) {
  return (
    <svg
