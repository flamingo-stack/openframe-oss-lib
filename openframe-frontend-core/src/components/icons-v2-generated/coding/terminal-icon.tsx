...
export interface TerminalIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function TerminalIcon({ className = '', size = 24, color = 'currentColor', ...props }: TerminalIconProps) {
  return (
    <svg
