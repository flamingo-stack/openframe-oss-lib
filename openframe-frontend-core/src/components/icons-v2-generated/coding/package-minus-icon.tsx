...
export interface PackageMinusIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function PackageMinusIcon({
  ...
  return (
    ...
    >
      ...
      />
      <path fill={color} d="M22 17.875a1.125 1.125 0 0 1 0 2.25h-6a1.125 1.125 0 0 1 0-2.25z" />
    </svg>
  );
}
