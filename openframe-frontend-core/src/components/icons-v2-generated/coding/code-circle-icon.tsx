...
export interface CodeCircleIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function CodeCircleIcon({ className = '', size = 24, color = 'currentColor', ...props }: CodeCircleIconProps) {
  return (
    <svg
