...
export interface WebDesignIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function WebDesignIcon({ className = '', size = 24, color = 'currentColor', ...props }: WebDesignIconProps) {
  return (
    <svg
