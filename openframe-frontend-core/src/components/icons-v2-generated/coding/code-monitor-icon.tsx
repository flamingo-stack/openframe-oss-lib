...
export interface CodeMonitorIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function CodeMonitorIcon({ className = '', size = 24, color = 'currentColor', ...props }: CodeMonitorIconProps) {
  return (
    <svg
