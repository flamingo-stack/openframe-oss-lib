...
export interface PackageLockIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function PackageLockIcon({ className = '', size = 24, color = 'currentColor', ...props }: PackageLockIconProps) {
  return (
    <svg
