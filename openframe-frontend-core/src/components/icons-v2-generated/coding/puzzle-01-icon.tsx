...
export interface Puzzle01IconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function Puzzle01Icon({ className = '', size = 24, color = 'currentColor', ...props }: Puzzle01IconProps) {
  return (
    <svg
