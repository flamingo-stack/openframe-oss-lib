...
export interface BracketCurlyCheckIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function BracketCurlyCheckIcon({
  className = '',
  size = 24,
  color = 'currentColor',
  ...props
}: BracketCurlyCheckIconProps) {
  return (
    <svg
