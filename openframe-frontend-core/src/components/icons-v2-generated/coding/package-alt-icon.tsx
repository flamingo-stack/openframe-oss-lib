...
export interface PackageAltIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function PackageAltIcon({ className = '', size = 24, color = 'currentColor', ...props }: PackageAltIconProps) {
  return (
    <svg
