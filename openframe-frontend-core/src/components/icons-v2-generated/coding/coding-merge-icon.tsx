...
export interface CodingMergeIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function CodingMergeIcon({ className = '', size = 24, color = 'currentColor', ...props }: CodingMergeIconProps) {
  return (
    <svg
