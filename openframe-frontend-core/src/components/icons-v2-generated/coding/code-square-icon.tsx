...
export interface CodeSquareIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function CodeSquareIcon({ className = '', size = 24, color = 'currentColor', ...props }: CodeSquareIconProps) {
  return (
    <svg
