...
export interface CodeIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function CodeIcon({ className = '', size = 24, color = 'currentColor', ...props }: CodeIconProps) {
  return (
    <svg
