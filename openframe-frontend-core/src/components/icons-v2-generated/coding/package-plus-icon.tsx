...
export interface PackagePlusIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function PackagePlusIcon({ className = '', size = 24, color = 'currentColor', ...props }: PackagePlusIconProps) {
  return (
    <svg
