...
export interface CodeBrowserIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function CodeBrowserIcon({ className = '', size = 24, color = 'currentColor', ...props }: CodeBrowserIconProps) {
  return (
    <svg
