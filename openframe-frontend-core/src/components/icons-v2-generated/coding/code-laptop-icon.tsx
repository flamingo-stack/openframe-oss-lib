...
export interface CodeLaptopIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function CodeLaptopIcon({ className = '', size = 24, color = 'currentColor', ...props }: CodeLaptopIconProps) {
  return (
    <svg
