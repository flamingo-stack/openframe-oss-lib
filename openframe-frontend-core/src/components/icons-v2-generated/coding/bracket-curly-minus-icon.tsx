...
export interface BracketCurlyMinusIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function BracketCurlyMinusIcon({
  className = '',
  size = 24,
  color = 'currentColor',
  ...props
}: BracketCurlyMinusIconProps) {
  return (
    <svg
