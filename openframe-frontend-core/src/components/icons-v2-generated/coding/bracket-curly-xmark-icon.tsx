...
export interface BracketCurlyXmarkIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function BracketCurlyXmarkIcon({
  className = '',
  size = 24,
  color = 'currentColor',
  ...props
}: BracketCurlyXmarkIconProps) {
  return (
    <svg
