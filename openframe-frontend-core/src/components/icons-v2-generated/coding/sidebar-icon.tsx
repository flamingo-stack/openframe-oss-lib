...
export interface SidebarIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function SidebarIcon({ className = '', size = 24, color = 'currentColor', ...props }: SidebarIconProps) {
  return (
    <svg
