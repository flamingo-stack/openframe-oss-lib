...
export interface CodeScanIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function CodeScanIcon({ className = '', size = 24, color = 'currentColor', ...props }: CodeScanIconProps) {
  return (
    <svg
