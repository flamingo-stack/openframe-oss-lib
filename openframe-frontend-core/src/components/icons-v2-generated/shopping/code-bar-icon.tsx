...
export interface CodeBarIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function CodeBarIcon({ className = '', size = 24, color = 'currentColor', ...props }: CodeBarIconProps) {
  return (
    <svg
