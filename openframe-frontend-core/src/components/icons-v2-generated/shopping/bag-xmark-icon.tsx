...
export interface BagXmarkIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function BagXmarkIcon({ className = '', size = 24, color = 'currentColor', ...props }: BagXmarkIconProps) {
  return (
    <svg
