...
export interface FeedbackIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function FeedbackIcon({ className = '', size = 24, color = 'currentColor', ...props }: FeedbackIconProps) {
  return (
    <svg
