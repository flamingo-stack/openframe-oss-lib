...
export interface Megaphone01IconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function Megaphone01Icon({ className = '', size = 24, color = 'currentColor', ...props }: Megaphone01IconProps) {
  return (
    <svg
