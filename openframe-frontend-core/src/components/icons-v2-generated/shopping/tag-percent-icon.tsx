...
export interface TagPercentIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function TagPercentIcon({ className = '', size = 24, color = 'currentColor', ...props }: TagPercentIconProps) {
  return (
    <svg
