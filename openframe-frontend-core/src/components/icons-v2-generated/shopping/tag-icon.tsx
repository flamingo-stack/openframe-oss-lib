...
export interface TagIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function TagIcon({ className = '', size = 24, color = 'currentColor', ...props }: TagIconProps) {
  return (
    <svg
