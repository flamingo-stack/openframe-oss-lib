...
export interface GiftIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function GiftIcon({ className = '', size = 24, color = 'currentColor', ...props }: GiftIconProps) {
  return (
    <svg
