...
export interface ThumbsDownIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function ThumbsDownIcon({ className = '', size = 24, color = 'currentColor', ...props }: ThumbsDownIconProps) {
  return (
    <svg
      ...
      {...props}
    >
      <path fill={color} d="M15.875 13.5V2a1.125 1.125 0 0 1 2.25 0v11.5a1.125 1.125 0 0 1-2.25 0" />
      <path
        fill={color}
