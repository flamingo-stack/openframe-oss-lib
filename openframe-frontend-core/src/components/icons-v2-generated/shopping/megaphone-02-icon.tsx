...
export interface Megaphone02IconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function Megaphone02Icon({ className = '', size = 24, color = 'currentColor', ...props }: Megaphone02IconProps) {
  return (
    <svg
