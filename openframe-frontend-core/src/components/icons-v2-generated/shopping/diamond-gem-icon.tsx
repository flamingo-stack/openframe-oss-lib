...
export interface DiamondGemIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function DiamondGemIcon({ className = '', size = 24, color = 'currentColor', ...props }: DiamondGemIconProps) {
  return (
    <svg
