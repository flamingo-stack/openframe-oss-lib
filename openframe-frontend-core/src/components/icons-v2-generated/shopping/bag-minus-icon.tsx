...
export interface BagMinusIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function BagMinusIcon({ className = '', size = 24, color = 'currentColor', ...props }: BagMinusIconProps) {
  return (
    <svg
