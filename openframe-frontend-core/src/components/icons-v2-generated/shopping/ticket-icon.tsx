...
export interface TicketIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function TicketIcon({ className = '', size = 24, color = 'currentColor', ...props }: TicketIconProps) {
  return (
    <svg
