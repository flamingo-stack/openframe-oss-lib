...
export interface BagAltIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function BagAltIcon({ className = '', size = 24, color = 'currentColor', ...props }: BagAltIconProps) {
  return (
    <svg
