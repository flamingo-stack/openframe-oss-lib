...
export interface ThumbsUpIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function ThumbsUpIcon({ className = '', size = 24, color = 'currentColor', ...props }: ThumbsUpIconProps) {
  return (
    <svg
      ...
      {...props}
    >
      <path fill={color} d="M5.875 22V10.5a1.125 1.125 0 0 1 2.25 0V22a1.125 1.125 0 0 1-2.25 0" />
      <path
        fill={color}
