...
export interface CrownIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function CrownIcon({ className = '', size = 24, color = 'currentColor', ...props }: CrownIconProps) {
  return (
    <svg
      ...
      {...props}
    >
      <path fill={color} d="m19 16.375.115.006a1.125 1.125 0 0 1 0 2.238l-.115.006H5a1.125 1.125 0 0 1 0-2.25z" />
      <path
        fill={color}
