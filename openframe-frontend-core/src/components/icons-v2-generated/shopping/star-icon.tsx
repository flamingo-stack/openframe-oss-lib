...
export interface StarIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function StarIcon({ className = '', size = 24, color = 'currentColor', ...props }: StarIconProps) {
  return (
    <svg
