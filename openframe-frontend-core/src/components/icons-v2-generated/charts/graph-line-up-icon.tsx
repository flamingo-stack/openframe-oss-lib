...
export interface GraphLineUpIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function GraphLineUpIcon({ className = '', size = 24, color = 'currentColor', ...props }: GraphLineUpIconProps) {
  return (
    <svg
