...
export interface ChartLineUpIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function ChartLineUpIcon({ className = '', size = 24, color = 'currentColor', ...props }: ChartLineUpIconProps) {
  return (
    <svg
