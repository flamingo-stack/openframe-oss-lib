...
export interface ActivityIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function ActivityIcon({ className = '', size = 24, color = 'currentColor', ...props }: ActivityIconProps) {
  return (
    <svg
