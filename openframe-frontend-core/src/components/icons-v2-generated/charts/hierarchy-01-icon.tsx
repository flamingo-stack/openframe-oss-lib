...
export interface Hierarchy01IconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function Hierarchy01Icon({ className = '', size = 24, color = 'currentColor', ...props }: Hierarchy01IconProps) {
  return (
    <svg
