...
export interface AnalysisIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function AnalysisIcon({ className = '', size = 24, color = 'currentColor', ...props }: AnalysisIconProps) {
  return (
    <svg
