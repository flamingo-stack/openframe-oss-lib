...
export interface TrendUpIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function TrendUpIcon({ className = '', size = 24, color = 'currentColor', ...props }: TrendUpIconProps) {
  return (
    <svg
