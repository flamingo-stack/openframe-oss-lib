...
export interface ChartRadarIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function ChartRadarIcon({ className = '', size = 24, color = 'currentColor', ...props }: ChartRadarIconProps) {
  return (
    <svg
