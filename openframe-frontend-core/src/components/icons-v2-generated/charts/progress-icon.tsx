...
export interface ProgressIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function ProgressIcon({ className = '', size = 24, color = 'currentColor', ...props }: ProgressIconProps) {
  return (
    <svg
