...
export interface GraphMixedIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function GraphMixedIcon({ className = '', size = 24, color = 'currentColor', ...props }: GraphMixedIconProps) {
  return (
    <svg
