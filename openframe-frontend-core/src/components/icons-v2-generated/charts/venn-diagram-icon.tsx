...
export interface VennDiagramIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function VennDiagramIcon({ className = '', size = 24, color = 'currentColor', ...props }: VennDiagramIconProps) {
  return (
    <svg
