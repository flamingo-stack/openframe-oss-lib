...
export interface XmarkCircleIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function XmarkCircleIcon({ className = '', size = 24, color = 'currentColor', ...props }: XmarkCircleIconProps) {
  return (
    <svg
