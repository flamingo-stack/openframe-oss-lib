...
export interface ChecksIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function ChecksIcon({ className = '', size = 24, color = 'currentColor', ...props }: ChecksIconProps) {
  return (
    <svg
