...
export interface CheckAltIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function CheckAltIcon({ className = '', size = 24, color = 'currentColor', ...props }: CheckAltIconProps) {
  return (
    <svg
