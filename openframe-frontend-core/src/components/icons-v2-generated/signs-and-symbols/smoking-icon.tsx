...
export interface SmokingIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function SmokingIcon({ className = '', size = 24, color = 'currentColor', ...props }: SmokingIconProps) {
  return (
    <svg
