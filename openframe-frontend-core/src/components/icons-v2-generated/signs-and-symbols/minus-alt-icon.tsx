...
export interface MinusAltIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function MinusAltIcon({ className = '', size = 24, color = 'currentColor', ...props }: MinusAltIconProps) {
  return (
    <svg
