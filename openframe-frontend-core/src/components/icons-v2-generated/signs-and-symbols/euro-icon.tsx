...
export interface EuroIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function EuroIcon({ className = '', size = 24, color = 'currentColor', ...props }: EuroIconProps) {
  return (
    <svg
