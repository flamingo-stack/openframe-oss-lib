...
export interface XmarkSquareIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function XmarkSquareIcon({ className = '', size = 24, color = 'currentColor', ...props }: XmarkSquareIconProps) {
  return (
    <svg
