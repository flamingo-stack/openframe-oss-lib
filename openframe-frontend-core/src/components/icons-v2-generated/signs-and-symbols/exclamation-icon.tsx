...
export interface ExclamationIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function ExclamationIcon({ className = '', size = 24, color = 'currentColor', ...props }: ExclamationIconProps) {
  return (
    <svg
