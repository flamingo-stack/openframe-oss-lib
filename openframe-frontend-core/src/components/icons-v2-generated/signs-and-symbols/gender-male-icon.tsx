...
export interface GenderMaleIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function GenderMaleIcon({ className = '', size = 24, color = 'currentColor', ...props }: GenderMaleIconProps) {
  return (
    <svg
