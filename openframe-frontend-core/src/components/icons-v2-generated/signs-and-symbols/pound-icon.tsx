...
export interface PoundIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function PoundIcon({ className = '', size = 24, color = 'currentColor', ...props }: PoundIconProps) {
  return (
    <svg
    ...
    >
      ...
      />
      <path fill={color} d="m14 11.375.115.006a1.125 1.125 0 0 1 0 2.238l-.116.006H6a1.125 1.125 0 0 1 0-2.25z" />
    </svg>
  );
}
