...
export interface PlusAltIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function PlusAltIcon({ className = '', size = 24, color = 'currentColor', ...props }: PlusAltIconProps) {
  return (
    <svg
