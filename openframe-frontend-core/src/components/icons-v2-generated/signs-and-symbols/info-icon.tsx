...
export interface InfoIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function InfoIcon({ className = '', size = 24, color = 'currentColor', ...props }: InfoIconProps) {
  return (
    <svg
