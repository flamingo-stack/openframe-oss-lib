...
export interface SignFemaleIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function SignFemaleIcon({ className = '', size = 24, color = 'currentColor', ...props }: SignFemaleIconProps) {
  return (
    <svg
