...
export interface QuestionAltIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function QuestionAltIcon({ className = '', size = 24, color = 'currentColor', ...props }: QuestionAltIconProps) {
  return (
    <svg
