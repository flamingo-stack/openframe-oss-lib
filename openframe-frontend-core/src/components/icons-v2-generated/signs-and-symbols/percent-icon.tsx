...
export interface PercentIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function PercentIcon({ className = '', size = 24, color = 'currentColor', ...props }: PercentIconProps) {
  return (
    <svg
