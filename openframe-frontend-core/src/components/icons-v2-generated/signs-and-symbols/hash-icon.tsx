...
export interface HashIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function HashIcon({ className = '', size = 24, color = 'currentColor', ...props }: HashIconProps) {
  return (
    <svg
