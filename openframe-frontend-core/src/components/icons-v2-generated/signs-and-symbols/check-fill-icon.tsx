...
export interface CheckFillIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function CheckFillIcon({ className = '', size = 24, color = 'currentColor', ...props }: CheckFillIconProps) {
  return (
    <svg
