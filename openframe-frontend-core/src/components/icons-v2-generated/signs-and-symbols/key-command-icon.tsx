...
export interface KeyCommandIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function KeyCommandIcon({ className = '', size = 24, color = 'currentColor', ...props }: KeyCommandIconProps) {
  return (
    <svg
