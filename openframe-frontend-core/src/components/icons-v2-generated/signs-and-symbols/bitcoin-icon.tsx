...
export interface BitcoinIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function BitcoinIcon({ className = '', size = 24, color = 'currentColor', ...props }: BitcoinIconProps) {
  return (
    <svg
