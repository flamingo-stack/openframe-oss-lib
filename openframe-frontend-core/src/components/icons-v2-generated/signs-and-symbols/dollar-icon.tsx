...
export interface DollarIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function DollarIcon({ className = '', size = 24, color = 'currentColor', ...props }: DollarIconProps) {
  return (
    <svg
