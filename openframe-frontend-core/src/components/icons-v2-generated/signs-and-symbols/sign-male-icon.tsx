...
export interface SignMaleIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function SignMaleIcon({ className = '', size = 24, color = 'currentColor', ...props }: SignMaleIconProps) {
  return (
    <svg
