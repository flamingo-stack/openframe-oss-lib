...
export interface InfoCircleIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function InfoCircleIcon({ className = '', size = 24, color = 'currentColor', ...props }: InfoCircleIconProps) {
  return (
    <svg
