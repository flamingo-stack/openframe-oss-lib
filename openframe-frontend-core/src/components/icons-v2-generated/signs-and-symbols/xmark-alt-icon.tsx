...
export interface XmarkAltIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function XmarkAltIcon({ className = '', size = 24, color = 'currentColor', ...props }: XmarkAltIconProps) {
  return (
    <svg
