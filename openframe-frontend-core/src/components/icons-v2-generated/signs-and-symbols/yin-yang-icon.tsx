...
export interface YinYangIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function YinYangIcon({ className = '', size = 24, color = 'currentColor', ...props }: YinYangIconProps) {
  return (
    <svg
