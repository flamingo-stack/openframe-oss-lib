...
export interface UmbrellaIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function UmbrellaIcon({ className = '', size = 24, color = 'currentColor', ...props }: UmbrellaIconProps) {
  return (
    <svg
