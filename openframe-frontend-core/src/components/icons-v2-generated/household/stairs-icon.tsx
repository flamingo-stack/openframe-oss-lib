...
export interface StairsIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function StairsIcon({ className = '', size = 24, color = 'currentColor', ...props }: StairsIconProps) {
  return (
    <svg
