...
export interface SirenIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function SirenIcon({ className = '', size = 24, color = 'currentColor', ...props }: SirenIconProps) {
  return (
    <svg
