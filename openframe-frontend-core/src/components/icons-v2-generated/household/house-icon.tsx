...
export interface HouseIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function HouseIcon({ className = '', size = 24, color = 'currentColor', ...props }: HouseIconProps) {
  return (
    <svg
