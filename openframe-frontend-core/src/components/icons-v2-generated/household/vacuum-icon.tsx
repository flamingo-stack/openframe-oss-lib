...
export interface VacuumIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function VacuumIcon({ className = '', size = 24, color = 'currentColor', ...props }: VacuumIconProps) {
  return (
    <svg
