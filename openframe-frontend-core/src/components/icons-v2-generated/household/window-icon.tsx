...
export interface WindowIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function WindowIcon({ className = '', size = 24, color = 'currentColor', ...props }: WindowIconProps) {
  return (
    <svg
