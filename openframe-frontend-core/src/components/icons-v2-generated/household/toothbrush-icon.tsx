...
export interface ToothbrushIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function ToothbrushIcon({ className = '', size = 24, color = 'currentColor', ...props }: ToothbrushIconProps) {
  return (
    <svg
