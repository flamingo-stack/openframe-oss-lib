...
export interface LampIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function LampIcon({ className = '', size = 24, color = 'currentColor', ...props }: LampIconProps) {
  return (
    <svg
