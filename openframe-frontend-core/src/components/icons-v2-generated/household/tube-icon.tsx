...
export interface TubeIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function TubeIcon({ className = '', size = 24, color = 'currentColor', ...props }: TubeIconProps) {
  return (
    <svg
