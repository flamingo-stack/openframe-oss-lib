...
export interface BedPersonIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function BedPersonIcon({ className = '', size = 24, color = 'currentColor', ...props }: BedPersonIconProps) {
  return (
    <svg
