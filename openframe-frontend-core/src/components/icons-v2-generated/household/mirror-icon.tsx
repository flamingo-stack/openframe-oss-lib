...
export interface MirrorIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function MirrorIcon({ className = '', size = 24, color = 'currentColor', ...props }: MirrorIconProps) {
  return (
    <svg
