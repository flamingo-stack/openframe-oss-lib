...
export interface HouseDoorIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function HouseDoorIcon({ className = '', size = 24, color = 'currentColor', ...props }: HouseDoorIconProps) {
  return (
    <svg
