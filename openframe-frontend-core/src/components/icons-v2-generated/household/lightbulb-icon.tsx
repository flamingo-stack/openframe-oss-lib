...
export interface LightbulbIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function LightbulbIcon({ className = '', size = 24, color = 'currentColor', ...props }: LightbulbIconProps) {
  return (
    <svg
