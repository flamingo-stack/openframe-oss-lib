...
export interface CleaverIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function CleaverIcon({ className = '', size = 24, color = 'currentColor', ...props }: CleaverIconProps) {
  return (
    <svg
