...
export interface BedFrontIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function BedFrontIcon({ className = '', size = 24, color = 'currentColor', ...props }: BedFrontIconProps) {
  return (
    <svg
