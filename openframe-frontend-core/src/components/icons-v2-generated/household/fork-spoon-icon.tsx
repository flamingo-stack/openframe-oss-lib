...
export interface ForkSpoonIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function ForkSpoonIcon({ className = '', size = 24, color = 'currentColor', ...props }: ForkSpoonIconProps) {
  return (
    <svg
