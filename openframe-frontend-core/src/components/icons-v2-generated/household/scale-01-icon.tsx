...
export interface Scale01IconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function Scale01Icon({ className = '', size = 24, color = 'currentColor', ...props }: Scale01IconProps) {
  return (
    <svg
