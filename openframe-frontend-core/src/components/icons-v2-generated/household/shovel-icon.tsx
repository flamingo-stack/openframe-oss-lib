...
export interface ShovelIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function ShovelIcon({ className = '', size = 24, color = 'currentColor', ...props }: ShovelIconProps) {
  return (
    <svg
