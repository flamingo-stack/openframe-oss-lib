...
export interface ChairIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function ChairIcon({ className = '', size = 24, color = 'currentColor', ...props }: ChairIconProps) {
  return (
    <svg
