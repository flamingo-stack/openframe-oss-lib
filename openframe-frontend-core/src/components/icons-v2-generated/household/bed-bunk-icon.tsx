...
export interface BedBunkIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function BedBunkIcon({ className = '', size = 24, color = 'currentColor', ...props }: BedBunkIconProps) {
  return (
    <svg
