...
export interface ForkPlateIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function ForkPlateIcon({ className = '', size = 24, color = 'currentColor', ...props }: ForkPlateIconProps) {
  return (
    <svg
