...
export interface Scale02IconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function Scale02Icon({ className = '', size = 24, color = 'currentColor', ...props }: Scale02IconProps) {
  return (
    <svg
