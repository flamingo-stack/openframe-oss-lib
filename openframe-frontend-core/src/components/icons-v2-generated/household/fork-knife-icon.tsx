...
export interface ForkKnifeIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function ForkKnifeIcon({ className = '', size = 24, color = 'currentColor', ...props }: ForkKnifeIconProps) {
  return (
    <svg
