...
export interface WrenchIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function WrenchIcon({ className = '', size = 24, color = 'currentColor', ...props }: WrenchIconProps) {
  return (
    <svg
