...
export interface CouchIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function CouchIcon({ className = '', size = 24, color = 'currentColor', ...props }: CouchIconProps) {
  return (
    <svg
