...
export interface MagnetIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function MagnetIcon({ className = '', size = 24, color = 'currentColor', ...props }: MagnetIconProps) {
  return (
    <svg
