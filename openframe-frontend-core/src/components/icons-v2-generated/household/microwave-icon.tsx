...
export interface MicrowaveIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function MicrowaveIcon({ className = '', size = 24, color = 'currentColor', ...props }: MicrowaveIconProps) {
  return (
    <svg
