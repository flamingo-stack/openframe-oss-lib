...
export interface BathIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function BathIcon({ className = '', size = 24, color = 'currentColor', ...props }: BathIconProps) {
  return (
    <svg
