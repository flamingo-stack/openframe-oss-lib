...
export interface Dispenser01IconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function Dispenser01Icon({ className = '', size = 24, color = 'currentColor', ...props }: Dispenser01IconProps) {
  return (
    <svg
