...
export interface PotIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function PotIcon({ className = '', size = 24, color = 'currentColor', ...props }: PotIconProps) {
  return (
    <svg
