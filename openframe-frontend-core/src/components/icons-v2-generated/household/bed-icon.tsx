...
export interface BedIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function BedIcon({ className = '', size = 24, color = 'currentColor', ...props }: BedIconProps) {
  return (
    <svg
