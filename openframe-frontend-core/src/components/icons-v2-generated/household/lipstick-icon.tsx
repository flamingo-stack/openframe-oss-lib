...
export interface LipstickIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function LipstickIcon({ className = '', size = 24, color = 'currentColor', ...props }: LipstickIconProps) {
  return (
    <svg
