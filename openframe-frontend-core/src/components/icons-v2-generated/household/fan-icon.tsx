...
export interface FanIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function FanIcon({ className = '', size = 24, color = 'currentColor', ...props }: FanIconProps) {
  return (
    <svg
