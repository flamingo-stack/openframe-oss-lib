...
export interface SocketIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function SocketIcon({ className = '', size = 24, color = 'currentColor', ...props }: SocketIconProps) {
  return (
    <svg
