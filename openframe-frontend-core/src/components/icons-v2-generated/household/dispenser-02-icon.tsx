...
export interface Dispenser02IconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function Dispenser02Icon({ className = '', size = 24, color = 'currentColor', ...props }: Dispenser02IconProps) {
  return (
    <svg
