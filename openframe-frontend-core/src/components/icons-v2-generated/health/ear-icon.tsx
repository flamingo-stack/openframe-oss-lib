...
export interface EarIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function EarIcon({ className = '', size = 24, color = 'currentColor', ...props }: EarIconProps) {
  return (
    <svg
