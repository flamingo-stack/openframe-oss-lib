...
export interface HandIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function HandIcon({ className = '', size = 24, color = 'currentColor', ...props }: HandIconProps) {
  return (
    <svg
