...
export interface PulseIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function PulseIcon({ className = '', size = 24, color = 'currentColor', ...props }: PulseIconProps) {
  return (
    <svg
