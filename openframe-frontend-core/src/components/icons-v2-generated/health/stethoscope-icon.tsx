...
export interface StethoscopeIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function StethoscopeIcon({ className = '', size = 24, color = 'currentColor', ...props }: StethoscopeIconProps) {
  return (
    <svg
