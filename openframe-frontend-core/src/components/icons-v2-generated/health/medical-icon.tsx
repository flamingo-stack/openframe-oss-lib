...
export interface MedicalIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function MedicalIcon({ className = '', size = 24, color = 'currentColor', ...props }: MedicalIconProps) {
  return (
    <svg
