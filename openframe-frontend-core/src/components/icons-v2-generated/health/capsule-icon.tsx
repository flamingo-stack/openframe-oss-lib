...
export interface CapsuleIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function CapsuleIcon({ className = '', size = 24, color = 'currentColor', ...props }: CapsuleIconProps) {
  return (
    <svg
