...
export interface SkullIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function SkullIcon({ className = '', size = 24, color = 'currentColor', ...props }: SkullIconProps) {
  return (
    <svg
