...
export interface BookMedicalIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function BookMedicalIcon({ className = '', size = 24, color = 'currentColor', ...props }: BookMedicalIconProps) {
  return (
    <svg
