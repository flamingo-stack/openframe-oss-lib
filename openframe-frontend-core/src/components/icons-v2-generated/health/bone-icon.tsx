...
export interface BoneIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function BoneIcon({ className = '', size = 24, color = 'currentColor', ...props }: BoneIconProps) {
  return (
    <svg
