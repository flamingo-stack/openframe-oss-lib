...
export interface SocksIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function SocksIcon({ className = '', size = 24, color = 'currentColor', ...props }: SocksIconProps) {
  return (
    <svg
