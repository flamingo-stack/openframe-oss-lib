...
export interface HangerIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function HangerIcon({ className = '', size = 24, color = 'currentColor', ...props }: HangerIconProps) {
  return (
    <svg
