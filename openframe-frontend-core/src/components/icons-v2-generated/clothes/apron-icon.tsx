...
export interface ApronIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function ApronIcon({ className = '', size = 24, color = 'currentColor', ...props }: ApronIconProps) {
  return (
    <svg
