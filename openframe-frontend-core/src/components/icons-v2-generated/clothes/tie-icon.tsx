...
export interface TieIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function TieIcon({ className = '', size = 24, color = 'currentColor', ...props }: TieIconProps) {
  return (
    <svg
