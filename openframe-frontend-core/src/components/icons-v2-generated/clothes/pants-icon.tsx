...
export interface PantsIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function PantsIcon({ className = '', size = 24, color = 'currentColor', ...props }: PantsIconProps) {
  return (
    <svg
