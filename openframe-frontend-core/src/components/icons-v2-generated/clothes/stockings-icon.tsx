...
export interface StockingsIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function StockingsIcon({ className = '', size = 24, color = 'currentColor', ...props }: StockingsIconProps) {
  return (
    <svg
