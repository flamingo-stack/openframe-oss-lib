...
export interface ChefHatIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function ChefHatIcon({ className = '', size = 24, color = 'currentColor', ...props }: ChefHatIconProps) {
  return (
    <svg
