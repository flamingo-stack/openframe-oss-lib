...
export interface MicIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function MicIcon({ className = '', size = 24, color = 'currentColor', ...props }: MicIconProps) {
  return (
    <svg
