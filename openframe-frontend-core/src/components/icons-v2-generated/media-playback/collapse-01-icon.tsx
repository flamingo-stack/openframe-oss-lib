...
export interface Collapse01IconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function Collapse01Icon({ className = '', size = 24, color = 'currentColor', ...props }: Collapse01IconProps) {
  return (
    <svg
