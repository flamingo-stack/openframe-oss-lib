...
export interface FastForwardIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function FastForwardIcon({ className = '', size = 24, color = 'currentColor', ...props }: FastForwardIconProps) {
  return (
    <svg
