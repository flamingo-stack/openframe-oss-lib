...
export interface Collapse02IconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function Collapse02Icon({ className = '', size = 24, color = 'currentColor', ...props }: Collapse02IconProps) {
  return (
    <svg
