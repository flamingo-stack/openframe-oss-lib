...
export interface WaveformIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function WaveformIcon({ className = '', size = 24, color = 'currentColor', ...props }: WaveformIconProps) {
  return (
    <svg
