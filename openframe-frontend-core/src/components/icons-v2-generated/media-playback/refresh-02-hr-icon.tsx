...
export interface Refresh02HrIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function Refresh02HrIcon({ className = '', size = 24, color = 'currentColor', ...props }: Refresh02HrIconProps) {
  return (
    <svg
