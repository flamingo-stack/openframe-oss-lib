...
export interface Collapse03IconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function Collapse03Icon({ className = '', size = 24, color = 'currentColor', ...props }: Collapse03IconProps) {
  return (
    <svg
