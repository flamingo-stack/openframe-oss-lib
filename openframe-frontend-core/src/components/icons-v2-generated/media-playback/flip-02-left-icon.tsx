...
export interface Flip02LeftIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function Flip02LeftIcon({ className = '', size = 24, color = 'currentColor', ...props }: Flip02LeftIconProps) {
  return (
    <svg
