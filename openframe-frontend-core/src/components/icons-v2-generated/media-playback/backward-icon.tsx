...
export interface BackwardIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function BackwardIcon({ className = '', size = 24, color = 'currentColor', ...props }: BackwardIconProps) {
  return (
    <svg
