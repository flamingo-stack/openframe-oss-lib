...
export interface NextIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function NextIcon({ className = '', size = 24, color = 'currentColor', ...props }: NextIconProps) {
  return (
    <svg
