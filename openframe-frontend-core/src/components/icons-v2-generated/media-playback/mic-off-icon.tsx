...
export interface MicOffIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function MicOffIcon({ className = '', size = 24, color = 'currentColor', ...props }: MicOffIconProps) {
  return (
    <svg
