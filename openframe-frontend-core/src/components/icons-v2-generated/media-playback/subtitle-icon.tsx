...
export interface SubtitleIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function SubtitleIcon({ className = '', size = 24, color = 'currentColor', ...props }: SubtitleIconProps) {
  return (
    <svg
