...
export interface Expand01IconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function Expand01Icon({ className = '', size = 24, color = 'currentColor', ...props }: Expand01IconProps) {
  return (
    <svg
