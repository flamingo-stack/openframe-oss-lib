...
export interface Expand03IconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function Expand03Icon({ className = '', size = 24, color = 'currentColor', ...props }: Expand03IconProps) {
  return (
    <svg
