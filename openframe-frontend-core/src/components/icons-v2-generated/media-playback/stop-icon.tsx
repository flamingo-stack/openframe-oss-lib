...
export interface StopIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function StopIcon({ className = '', size = 24, color = 'currentColor', ...props }: StopIconProps) {
  return (
    <svg
