...
export interface MicAltIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function MicAltIcon({ className = '', size = 24, color = 'currentColor', ...props }: MicAltIconProps) {
  return (
    <svg
