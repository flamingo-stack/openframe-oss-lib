...
export interface PauseIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function PauseIcon({ className = '', size = 24, color = 'currentColor', ...props }: PauseIconProps) {
  return (
    <svg
