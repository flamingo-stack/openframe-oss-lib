...
export interface Expand04IconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function Expand04Icon({ className = '', size = 24, color = 'currentColor', ...props }: Expand04IconProps) {
  return (
    <svg
