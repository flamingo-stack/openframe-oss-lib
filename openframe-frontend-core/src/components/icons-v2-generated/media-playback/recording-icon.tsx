...
export interface RecordingIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function RecordingIcon({ className = '', size = 24, color = 'currentColor', ...props }: RecordingIconProps) {
  return (
    <svg
