...
export interface LayersPlusIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function LayersPlusIcon({ className = '', size = 24, color = 'currentColor', ...props }: LayersPlusIconProps) {
  return (
    <svg
