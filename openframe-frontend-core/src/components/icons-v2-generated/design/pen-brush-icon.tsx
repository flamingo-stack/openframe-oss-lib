...
export interface PenBrushIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function PenBrushIcon({ className = '', size = 24, color = 'currentColor', ...props }: PenBrushIconProps) {
  return (
    <svg
