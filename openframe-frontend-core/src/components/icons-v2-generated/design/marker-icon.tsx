...
export interface MarkerIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function MarkerIcon({ className = '', size = 24, color = 'currentColor', ...props }: MarkerIconProps) {
  return (
    <svg
