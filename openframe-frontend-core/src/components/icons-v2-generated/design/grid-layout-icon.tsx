...
export interface GridLayoutIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function GridLayoutIcon({ className = '', size = 24, color = 'currentColor', ...props }: GridLayoutIconProps) {
  return (
    <svg
