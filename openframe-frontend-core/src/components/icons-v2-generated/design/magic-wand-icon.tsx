...
export interface MagicWandIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function MagicWandIcon({ className = '', size = 24, color = 'currentColor', ...props }: MagicWandIconProps) {
  return (
    <svg
