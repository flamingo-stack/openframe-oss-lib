...
export interface EraserIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function EraserIcon({ className = '', size = 24, color = 'currentColor', ...props }: EraserIconProps) {
  return (
    <svg
