...
export interface ScissorsIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function ScissorsIcon({ className = '', size = 24, color = 'currentColor', ...props }: ScissorsIconProps) {
  return (
    <svg
