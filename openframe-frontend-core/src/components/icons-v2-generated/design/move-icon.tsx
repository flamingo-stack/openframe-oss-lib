...
export interface MoveIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function MoveIcon({ className = '', size = 24, color = 'currentColor', ...props }: MoveIconProps) {
  return (
    <svg
