...
export interface LayersMinusIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function LayersMinusIcon({ className = '', size = 24, color = 'currentColor', ...props }: LayersMinusIconProps) {
  return (
    <svg
