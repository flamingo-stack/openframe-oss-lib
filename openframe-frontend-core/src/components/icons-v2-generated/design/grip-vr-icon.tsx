...
export interface GripVrIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function GripVrIcon({ className = '', size = 24, color = 'currentColor', ...props }: GripVrIconProps) {
  return (
    <svg
