...
export interface TextToolIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function TextToolIcon({ className = '', size = 24, color = 'currentColor', ...props }: TextToolIconProps) {
  return (
    <svg
