...
export interface BookFontIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function BookFontIcon({ className = '', size = 24, color = 'currentColor', ...props }: BookFontIconProps) {
  return (
    <svg
    ...
    >
      ...
      <path
        fill={color}
        d="M10.225 6.14c.559-1.687 2.99-1.687 3.55 0l.05.175 1.769 7.424.022.113a1.125 1.125 0 0 1-2.178.52l-.033-.112-.39-1.634h-2.031l-.39 1.634a1.125 1.125 0 1 1-2.188-.521l1.77-7.424zm1.296 4.236h.958L12 8.367z"
      />
    </svg>
  );
}
