...
export interface ScalingUpIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function ScalingUpIcon({ className = '', size = 24, color = 'currentColor', ...props }: ScalingUpIconProps) {
  return (
    <svg
