...
export interface AlignTopIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function AlignTopIcon({ className = '', size = 24, color = 'currentColor', ...props }: AlignTopIconProps) {
  return (
    <svg
