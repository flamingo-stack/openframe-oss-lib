...
export interface ReflectHrIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function ReflectHrIcon({ className = '', size = 24, color = 'currentColor', ...props }: ReflectHrIconProps) {
  return (
    <svg
