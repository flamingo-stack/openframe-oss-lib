...
export interface Angle90IconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function Angle90Icon({ className = '', size = 24, color = 'currentColor', ...props }: Angle90IconProps) {
  return (
    <svg
