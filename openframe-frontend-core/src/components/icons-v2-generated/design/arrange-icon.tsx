...
export interface ArrangeIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function ArrangeIcon({ className = '', size = 24, color = 'currentColor', ...props }: ArrangeIconProps) {
  return (
    <svg
