...
export interface Pen01IconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function Pen01Icon({ className = '', size = 24, color = 'currentColor', ...props }: Pen01IconProps) {
  return (
    <svg
