...
export interface PenPointIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function PenPointIcon({ className = '', size = 24, color = 'currentColor', ...props }: PenPointIconProps) {
  return (
    <svg
      ...
      {...props}
    >
      <path fill={color} d="M5.705 16.704a1.125 1.125 0 1 1 1.59 1.591l-4.347 4.348a1.125 1.125 0 1 1-1.59-1.59z" />
      <path
        fill={color}
