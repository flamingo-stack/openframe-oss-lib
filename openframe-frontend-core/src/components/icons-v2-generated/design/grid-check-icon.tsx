...
export interface GridCheckIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function GridCheckIcon({ className = '', size = 24, color = 'currentColor', ...props }: GridCheckIconProps) {
  return (
    <svg
