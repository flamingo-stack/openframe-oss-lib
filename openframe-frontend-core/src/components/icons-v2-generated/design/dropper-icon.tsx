...
export interface DropperIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function DropperIcon({ className = '', size = 24, color = 'currentColor', ...props }: DropperIconProps) {
  return (
    <svg
