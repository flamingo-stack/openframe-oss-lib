...
export interface AngleIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function AngleIcon({ className = '', size = 24, color = 'currentColor', ...props }: AngleIconProps) {
  return (
    <svg
