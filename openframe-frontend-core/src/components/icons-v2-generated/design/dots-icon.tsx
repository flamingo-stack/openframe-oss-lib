...
export interface DotsIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function DotsIcon({ className = '', size = 24, color = 'currentColor', ...props }: DotsIconProps) {
  return (
    <svg
