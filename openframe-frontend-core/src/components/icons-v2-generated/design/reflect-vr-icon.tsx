...
export interface ReflectVrIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function ReflectVrIcon({ className = '', size = 24, color = 'currentColor', ...props }: ReflectVrIconProps) {
  return (
    <svg
