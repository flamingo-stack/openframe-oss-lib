...
export interface AlignRightIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function AlignRightIcon({ className = '', size = 24, color = 'currentColor', ...props }: AlignRightIconProps) {
  return (
    <svg
