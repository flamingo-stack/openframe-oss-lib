...
export interface GridPlusIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function GridPlusIcon({ className = '', size = 24, color = 'currentColor', ...props }: GridPlusIconProps) {
  return (
    <svg
