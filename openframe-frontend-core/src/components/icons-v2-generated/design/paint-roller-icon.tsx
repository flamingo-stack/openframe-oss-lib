...
export interface PaintRollerIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function PaintRollerIcon({ className = '', size = 24, color = 'currentColor', ...props }: PaintRollerIconProps) {
  return (
    <svg
