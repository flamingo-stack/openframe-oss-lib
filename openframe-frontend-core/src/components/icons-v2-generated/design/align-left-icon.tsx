...
export interface AlignLeftIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function AlignLeftIcon({ className = '', size = 24, color = 'currentColor', ...props }: AlignLeftIconProps) {
  return (
    <svg
