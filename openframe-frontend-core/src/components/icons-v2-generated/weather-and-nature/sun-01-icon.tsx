...
export interface Sun01IconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function Sun01Icon({ className = '', size = 24, color = 'currentColor', ...props }: Sun01IconProps) {
  return (
    <svg
