...
export interface WindIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function WindIcon({ className = '', size = 24, color = 'currentColor', ...props }: WindIconProps) {
  return (
    <svg
