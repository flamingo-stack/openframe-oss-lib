...
export interface TemperatureIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function TemperatureIcon({ className = '', size = 24, color = 'currentColor', ...props }: TemperatureIconProps) {
  return (
    <svg
