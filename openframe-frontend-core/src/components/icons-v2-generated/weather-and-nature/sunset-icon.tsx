...
export interface SunsetIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function SunsetIcon({ className = '', size = 24, color = 'currentColor', ...props }: SunsetIconProps) {
  return (
    <svg
