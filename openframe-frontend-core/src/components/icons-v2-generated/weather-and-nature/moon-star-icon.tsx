...
export interface MoonStarIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function MoonStarIcon({ className = '', size = 24, color = 'currentColor', ...props }: MoonStarIconProps) {
  return (
    <svg
