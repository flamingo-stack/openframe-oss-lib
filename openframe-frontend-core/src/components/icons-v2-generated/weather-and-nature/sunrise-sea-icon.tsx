...
export interface SunriseSeaIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function SunriseSeaIcon({ className = '', size = 24, color = 'currentColor', ...props }: SunriseSeaIconProps) {
  return (
    <svg
