...
export interface Sparkle02IconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function Sparkle02Icon({ className = '', size = 24, color = 'currentColor', ...props }: Sparkle02IconProps) {
  return (
    <svg
