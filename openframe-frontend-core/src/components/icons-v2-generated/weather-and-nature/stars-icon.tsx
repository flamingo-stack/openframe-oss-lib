...
export interface StarsIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function StarsIcon({ className = '', size = 24, color = 'currentColor', ...props }: StarsIconProps) {
  return (
    <svg
