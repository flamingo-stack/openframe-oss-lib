...
export interface TreeIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function TreeIcon({ className = '', size = 24, color = 'currentColor', ...props }: TreeIconProps) {
  return (
    <svg
      ...
      {...props}
    >
      <path fill={color} d="M10.875 22v-3a1.125 1.125 0 0 1 2.25 0v3a1.125 1.125 0 0 1-2.25 0" />
      <path
        fill={color}
