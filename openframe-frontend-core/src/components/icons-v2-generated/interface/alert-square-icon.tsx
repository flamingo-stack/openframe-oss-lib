...
export interface AlertSquareIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function AlertSquareIcon({ className = '', size = 24, color = 'currentColor', ...props }: AlertSquareIconProps) {
  return (
    <svg
