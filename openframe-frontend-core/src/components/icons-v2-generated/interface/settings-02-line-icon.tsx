...
export interface Settings02LineIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function Settings02LineIcon({
  ...
  return (
    ...
    >
      ...
      />
      <path fill={color} d="M12.9 8.326a1.125 1.125 0 0 1 1.864 1.253l-3.599 6a1.126 1.126 0 0 1-1.93-1.158l3.6-6z" />
    </svg>
  );
}
