...
export interface HomeIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function HomeIcon({ className = '', size = 24, color = 'currentColor', ...props }: HomeIconProps) {
  return (
    <svg
