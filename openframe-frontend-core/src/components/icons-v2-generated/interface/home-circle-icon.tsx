...
export interface HomeCircleIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function HomeCircleIcon({ className = '', size = 24, color = 'currentColor', ...props }: HomeCircleIconProps) {
  return (
    <svg
