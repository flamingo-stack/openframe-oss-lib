...
export interface Login02IconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function Login02Icon({ className = '', size = 24, color = 'currentColor', ...props }: Login02IconProps) {
  return (
    <svg
