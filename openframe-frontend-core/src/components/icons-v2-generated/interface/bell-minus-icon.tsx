...
export interface BellMinusIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function BellMinusIcon({ className = '', size = 24, color = 'currentColor', ...props }: BellMinusIconProps) {
  return (
    <svg
    ...
    >
      ...
      <path
        fill={color}
        d="m14 20.875.115.006a1.125 1.125 0 0 1 0 2.239l-.116.005h-3.998a1.125 1.125 0 0 1 0-2.25zm1-11.5a1.125 1.125 0 0 1 0 2.25H9a1.125 1.125 0 0 1 0-2.25z"
      />
    </svg>
  );
}
