...
export interface RadioWavesIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function RadioWavesIcon({ className = '', size = 24, color = 'currentColor', ...props }: RadioWavesIconProps) {
  return (
    <svg
