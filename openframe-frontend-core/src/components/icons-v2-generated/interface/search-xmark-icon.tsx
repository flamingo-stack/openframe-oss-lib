...
export interface SearchXmarkIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function SearchXmarkIcon({ className = '', size = 24, color = 'currentColor', ...props }: SearchXmarkIconProps) {
  return (
    <svg
