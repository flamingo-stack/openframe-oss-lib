...
export interface Menu02IconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function Menu02Icon({ className = '', size = 24, color = 'currentColor', ...props }: Menu02IconProps) {
  return (
    <svg
