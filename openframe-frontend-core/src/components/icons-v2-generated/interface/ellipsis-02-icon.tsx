...
export interface Ellipsis02IconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function Ellipsis02Icon({ className = '', size = 24, color = 'currentColor', ...props }: Ellipsis02IconProps) {
  return (
    <svg
