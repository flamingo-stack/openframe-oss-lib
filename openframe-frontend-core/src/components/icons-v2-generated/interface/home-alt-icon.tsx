...
export interface HomeAltIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function HomeAltIcon({ className = '', size = 24, color = 'currentColor', ...props }: HomeAltIconProps) {
  return (
    <svg
