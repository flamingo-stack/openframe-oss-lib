...
export interface BellIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function BellIcon({ className = '', size = 24, color = 'currentColor', ...props }: BellIconProps) {
  return (
    <svg
