...
export interface Download01IconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function Download01Icon({ className = '', size = 24, color = 'currentColor', ...props }: Download01IconProps) {
  return (
    <svg
