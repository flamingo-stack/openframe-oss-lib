...
export interface Link01IconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function Link01Icon({ className = '', size = 24, color = 'currentColor', ...props }: Link01IconProps) {
  return (
    <svg
      ...
      {...props}
    >
      <path fill={color} d="M14.205 8.205a1.125 1.125 0 1 1 1.59 1.59l-6 6a1.125 1.125 0 1 1-1.59-1.59z" />
      <path
        fill={color}
