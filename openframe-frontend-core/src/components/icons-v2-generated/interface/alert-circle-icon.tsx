...
export interface AlertCircleIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function AlertCircleIcon({ className = '', size = 24, color = 'currentColor', ...props }: AlertCircleIconProps) {
  return (
    <svg
