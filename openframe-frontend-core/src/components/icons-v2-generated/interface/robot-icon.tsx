...
export interface RobotIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function RobotIcon({ className = '', size = 24, color = 'currentColor', ...props }: RobotIconProps) {
  return (
    <svg
