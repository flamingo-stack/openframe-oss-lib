...
export function SearchIcon({ className = '', size = 24, color = 'currentColor', ...props }: SearchIconProps) {
  return (
    <svg
      ...
      {...props}
    >
      <path fill={color} d="M6.548 15.861a1.125 1.125 0 1 1 1.59 1.591l-4.343 4.343a1.125 1.125 0 1 1-1.59-1.59z" />
      <path
        fill={color}
