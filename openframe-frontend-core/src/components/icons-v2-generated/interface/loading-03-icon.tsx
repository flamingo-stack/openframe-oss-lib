...
export interface Loading03IconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function Loading03Icon({ className = '', size = 24, color = 'currentColor', ...props }: Loading03IconProps) {
  return (
    <svg
