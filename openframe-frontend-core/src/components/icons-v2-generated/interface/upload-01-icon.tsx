...
export interface Upload01IconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function Upload01Icon({ className = '', size = 24, color = 'currentColor', ...props }: Upload01IconProps) {
  return (
    <svg
