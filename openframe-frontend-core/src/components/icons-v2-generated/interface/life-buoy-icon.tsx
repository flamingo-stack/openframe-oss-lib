...
export interface LifeBuoyIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function LifeBuoyIcon({ className = '', size = 24, color = 'currentColor', ...props }: LifeBuoyIconProps) {
  return (
    <svg
