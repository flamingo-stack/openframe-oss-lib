...
export interface EyeCloseIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function EyeCloseIcon({ className = '', size = 24, color = 'currentColor', ...props }: EyeCloseIconProps) {
  return (
    <svg
