...
export interface BellCheckIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function BellCheckIcon({ className = '', size = 24, color = 'currentColor', ...props }: BellCheckIconProps) {
  return (
    <svg
