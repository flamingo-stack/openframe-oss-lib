...
export interface Login01IconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function Login01Icon({ className = '', size = 24, color = 'currentColor', ...props }: Login01IconProps) {
  return (
    <svg
