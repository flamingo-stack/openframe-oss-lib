...
export interface HomeDoorIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function HomeDoorIcon({ className = '', size = 24, color = 'currentColor', ...props }: HomeDoorIconProps) {
  return (
    <svg
    ...
    >
      <path
        fill={color}
        d="M13.875 21v-5a1.875 1.875 0 1 0-3.75 0v5a1.125 1.125 0 0 1-2.25 0v-5a4.125 4.125 0 1 1 8.25 0v5a1.125 1.125 0 0 1-2.25 0"
      />
      <path
        fill={color}
