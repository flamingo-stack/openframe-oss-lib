...
export interface HomeSmileIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function HomeSmileIcon({ className = '', size = 24, color = 'currentColor', ...props }: HomeSmileIconProps) {
  return (
    <svg
