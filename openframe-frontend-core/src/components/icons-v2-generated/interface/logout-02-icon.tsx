...
export interface Logout02IconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function Logout02Icon({ className = '', size = 24, color = 'currentColor', ...props }: Logout02IconProps) {
  return (
    <svg
