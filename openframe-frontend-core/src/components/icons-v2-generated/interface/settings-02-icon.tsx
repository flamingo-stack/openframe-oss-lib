...
export interface Settings02IconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function Settings02Icon({ className = '', size = 24, color = 'currentColor', ...props }: Settings02IconProps) {
  return (
    <svg
