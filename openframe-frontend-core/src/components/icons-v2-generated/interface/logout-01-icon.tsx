...
export interface Logout01IconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function Logout01Icon({ className = '', size = 24, color = 'currentColor', ...props }: Logout01IconProps) {
  return (
    <svg
