...
export interface BellOffIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function BellOffIcon({ className = '', size = 24, color = 'currentColor', ...props }: BellOffIconProps) {
  return (
    <svg
