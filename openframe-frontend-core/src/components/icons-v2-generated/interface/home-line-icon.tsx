...
export interface HomeLineIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function HomeLineIcon({ className = '', size = 24, color = 'currentColor', ...props }: HomeLineIconProps) {
  return (
    <svg
      ...
      {...props}
    >
      <path fill={color} d="M15 15.875a1.125 1.125 0 0 1 0 2.25H9a1.125 1.125 0 0 1 0-2.25z" />
      <path
        fill={color}
