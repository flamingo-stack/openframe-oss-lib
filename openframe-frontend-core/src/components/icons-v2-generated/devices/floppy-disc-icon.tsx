...
export interface FloppyDiscIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function FloppyDiscIcon({ className = '', size = 24, color = 'currentColor', ...props }: FloppyDiscIconProps) {
  return (
    <svg
