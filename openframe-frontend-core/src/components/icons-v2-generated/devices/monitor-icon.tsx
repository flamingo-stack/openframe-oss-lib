...
export interface MonitorIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function MonitorIcon({ className = '', size = 24, color = 'currentColor', ...props }: MonitorIconProps) {
  return (
    <svg
