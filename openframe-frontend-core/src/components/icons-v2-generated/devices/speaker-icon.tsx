...
export interface SpeakerIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function SpeakerIcon({ className = '', size = 24, color = 'currentColor', ...props }: SpeakerIconProps) {
  return (
    <svg
