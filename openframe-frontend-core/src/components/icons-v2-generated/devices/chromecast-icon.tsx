...
export interface ChromecastIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function ChromecastIcon({ className = '', size = 24, color = 'currentColor', ...props }: ChromecastIconProps) {
  return (
    <svg
