...
export interface SignalLevelIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function SignalLevelIcon({ className = '', size = 24, color = 'currentColor', ...props }: SignalLevelIconProps) {
  return (
    <svg
