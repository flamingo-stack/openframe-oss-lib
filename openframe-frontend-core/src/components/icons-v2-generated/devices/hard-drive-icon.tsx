...
export interface HardDriveIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function HardDriveIcon({ className = '', size = 24, color = 'currentColor', ...props }: HardDriveIconProps) {
  return (
    <svg
