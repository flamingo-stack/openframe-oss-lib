...
export interface AirdropIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function AirdropIcon({ className = '', size = 24, color = 'currentColor', ...props }: AirdropIconProps) {
  return (
    <svg
