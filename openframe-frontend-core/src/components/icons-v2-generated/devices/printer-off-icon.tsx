...
export interface PrinterOffIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function PrinterOffIcon({ className = '', size = 24, color = 'currentColor', ...props }: PrinterOffIconProps) {
  return (
    <svg
