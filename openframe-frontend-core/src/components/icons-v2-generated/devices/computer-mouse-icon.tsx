...
export interface ComputerMouseIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function ComputerMouseIcon({
  ...
  return (
    ...
    >
      ...
      />
      <path fill={color} d="M15.204 7.205a1.125 1.125 0 0 1 1.591 1.59l-2 2a1.125 1.125 0 1 1-1.59-1.59l2-2Z" />
    </svg>
  );
}
