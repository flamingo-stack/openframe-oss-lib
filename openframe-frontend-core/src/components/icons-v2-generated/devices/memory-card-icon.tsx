...
export interface MemoryCardIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function MemoryCardIcon({ className = '', size = 24, color = 'currentColor', ...props }: MemoryCardIconProps) {
  return (
    <svg
