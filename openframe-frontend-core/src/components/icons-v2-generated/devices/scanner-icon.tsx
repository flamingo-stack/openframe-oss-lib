...
export interface ScannerIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function ScannerIcon({ className = '', size = 24, color = 'currentColor', ...props }: ScannerIconProps) {
  return (
    <svg
