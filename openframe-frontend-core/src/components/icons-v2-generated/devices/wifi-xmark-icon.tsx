...
export interface WifiXmarkIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function WifiXmarkIcon({ className = '', size = 24, color = 'currentColor', ...props }: WifiXmarkIconProps) {
  return (
    <svg
