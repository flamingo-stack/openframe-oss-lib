...
export interface LaptopFileIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function LaptopFileIcon({ className = '', size = 24, color = 'currentColor', ...props }: LaptopFileIconProps) {
  return (
    <svg
