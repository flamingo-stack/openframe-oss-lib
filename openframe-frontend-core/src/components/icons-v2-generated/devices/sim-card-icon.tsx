...
export interface SimCardIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function SimCardIcon({ className = '', size = 24, color = 'currentColor', ...props }: SimCardIconProps) {
  return (
    <svg
