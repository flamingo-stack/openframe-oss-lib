...
export interface LaptopIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function LaptopIcon({ className = '', size = 24, color = 'currentColor', ...props }: LaptopIconProps) {
  return (
    <svg
