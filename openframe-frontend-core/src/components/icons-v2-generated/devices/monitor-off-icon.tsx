...
export interface MonitorOffIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function MonitorOffIcon({ className = '', size = 24, color = 'currentColor', ...props }: MonitorOffIconProps) {
  return (
    <svg
