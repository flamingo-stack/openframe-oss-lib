...
export interface AirplayIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function AirplayIcon({ className = '', size = 24, color = 'currentColor', ...props }: AirplayIconProps) {
  return (
    <svg
