...
export interface ProjectorIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function ProjectorIcon({ className = '', size = 24, color = 'currentColor', ...props }: ProjectorIconProps) {
  return (
    <svg
