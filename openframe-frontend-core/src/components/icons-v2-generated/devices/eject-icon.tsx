...
export interface EjectIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function EjectIcon({ className = '', size = 24, color = 'currentColor', ...props }: EjectIconProps) {
  return (
    <svg
