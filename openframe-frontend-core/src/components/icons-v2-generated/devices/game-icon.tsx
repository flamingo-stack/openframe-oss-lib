...
export interface GameIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function GameIcon({ className = '', size = 24, color = 'currentColor', ...props }: GameIconProps) {
  return (
    <svg
