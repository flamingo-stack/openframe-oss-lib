...
export interface PowerCircleIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function PowerCircleIcon({ className = '', size = 24, color = 'currentColor', ...props }: PowerCircleIconProps) {
  return (
    <svg
