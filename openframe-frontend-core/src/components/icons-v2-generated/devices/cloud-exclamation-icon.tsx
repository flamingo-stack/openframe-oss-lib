...
export interface CloudExclamationIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function CloudExclamationIcon({
  className = '',
  size = 24,
  color = 'currentColor',
  ...props
}: CloudExclamationIconProps) {
  return (
    <svg
    ...
    >
      ...
      <path
        fill={color}
        d="M9.875 11.5v-3a1.125 1.125 0 0 1 2.25 0v3a1.125 1.125 0 0 1-2.25 0m2.5 4a1.374 1.374 0 0 1-2.743.141l-.007-.14.007-.141a1.375 1.375 0 0 1 1.369-1.235l.14.007a1.376 1.376 0 0 1 1.233 1.369Z"
      />
    </svg>
  );
}
