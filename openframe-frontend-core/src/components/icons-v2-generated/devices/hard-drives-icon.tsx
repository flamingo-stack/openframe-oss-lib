...
export interface HardDrivesIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function HardDrivesIcon({ className = '', size = 24, color = 'currentColor', ...props }: HardDrivesIconProps) {
  return (
    <svg
