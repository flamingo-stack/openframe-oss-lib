...
export interface ConnectionIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function ConnectionIcon({ className = '', size = 24, color = 'currentColor', ...props }: ConnectionIconProps) {
  return (
    <svg
