...
export interface PowerIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function PowerIcon({ className = '', size = 24, color = 'currentColor', ...props }: PowerIconProps) {
  return (
    <svg
      ...
      {...props}
    >
      <path fill={color} d="M10.875 12V2a1.125 1.125 0 0 1 2.25 0v10a1.125 1.125 0 0 1-2.25 0" />
      <path
        fill={color}
