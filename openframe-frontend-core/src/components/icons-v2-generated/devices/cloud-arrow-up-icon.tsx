...
export interface CloudArrowUpIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function CloudArrowUpIcon({
  ...
  return (
    ...
    >
      ...
      <path
        fill={color}
        d="M9.875 15.5v-3.284l-1.08 1.08a1.125 1.125 0 1 1-1.59-1.591l3-3 .085-.078a1.125 1.125 0 0 1 1.505.078l3 3 .078.085a1.125 1.125 0 0 1-1.583 1.583l-.085-.078-1.08-1.08V15.5a1.125 1.125 0 0 1-2.25 0"
      />
    </svg>
  );
}
