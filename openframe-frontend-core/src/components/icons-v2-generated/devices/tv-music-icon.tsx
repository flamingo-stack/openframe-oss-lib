...
export interface TvMusicIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function TvMusicIcon({ className = '', size = 24, color = 'currentColor', ...props }: TvMusicIconProps) {
  return (
    <svg
