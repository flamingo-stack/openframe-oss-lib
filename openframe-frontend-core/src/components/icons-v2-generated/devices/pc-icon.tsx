...
export interface PcIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function PcIcon({ className = '', size = 24, color = 'currentColor', ...props }: PcIconProps) {
  return (
    <svg
