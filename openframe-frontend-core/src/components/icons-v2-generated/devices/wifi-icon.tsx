...
export interface WifiIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function WifiIcon({ className = '', size = 24, color = 'currentColor', ...props }: WifiIconProps) {
  return (
    <svg
