...
export interface CloudIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function CloudIcon({ className = '', size = 24, color = 'currentColor', ...props }: CloudIconProps) {
  return (
    <svg
