...
export interface Watch02IconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function Watch02Icon({ className = '', size = 24, color = 'currentColor', ...props }: Watch02IconProps) {
  return (
    <svg
