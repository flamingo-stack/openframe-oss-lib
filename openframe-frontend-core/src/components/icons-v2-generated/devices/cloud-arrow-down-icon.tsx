...
export interface CloudArrowDownIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function CloudArrowDownIcon({
  ...
  return (
    ...
    >
      ...
      <path
        fill={color}
        d="M9.875 9.5a1.125 1.125 0 0 1 2.25 0v3.284l1.08-1.08a1.125 1.125 0 1 1 1.59 1.591l-3 3c-.439.44-1.151.44-1.59 0l-3-3-.078-.085a1.125 1.125 0 0 1 1.583-1.583l.085.078 1.08 1.08z"
      />
    </svg>
  );
}
