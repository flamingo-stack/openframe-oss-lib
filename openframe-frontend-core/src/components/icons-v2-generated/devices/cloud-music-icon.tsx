...
export interface CloudMusicIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function CloudMusicIcon({ className = '', size = 24, color = 'currentColor', ...props }: CloudMusicIconProps) {
  return (
    <svg
    ...
    >
      ...
      <path
        fill={color}
        d="M13.392 7.876a2.125 2.125 0 0 1 2.232 2.122v4.4l-.002.048.002.054a2.125 2.125 0 0 1-4.239.217l-.01-.217.01-.217a2.125 2.125 0 0 1 1.99-1.903v-2.235l-3.75.625v4.73l-.01.217a2.125 2.125 0 0 1-4.23 0l-.01-.217.01-.218a2.124 2.124 0 0 1 1.99-1.901v-2.716c0-1.039.752-1.926 1.776-2.096l4-.667z"
      />
    </svg>
  );
}
