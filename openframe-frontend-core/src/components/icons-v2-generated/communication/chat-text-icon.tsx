...
export interface ChatTextIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function ChatTextIcon({ className = '', size = 24, color = 'currentColor', ...props }: ChatTextIconProps) {
  return (
    <svg
    ...
    >
      ...
      <path
        fill={color}
        d="m13 12.876.115.005a1.125 1.125 0 0 1 0 2.239l-.115.006H8a1.125 1.125 0 0 1 0-2.25zm3-4.001.115.006a1.125 1.125 0 0 1 0 2.238l-.115.006H8a1.125 1.125 0 0 1 0-2.25z"
      />
    </svg>
  );
}
