...
export interface Send01IconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function Send01Icon({ className = '', size = 24, color = 'currentColor', ...props }: Send01IconProps) {
  return (
    <svg
