...
export interface EmailBannedIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function EmailBannedIcon({ className = '', size = 24, color = 'currentColor', ...props }: EmailBannedIconProps) {
  return (
    <svg
