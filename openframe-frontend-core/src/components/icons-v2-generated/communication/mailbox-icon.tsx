...
export interface MailboxIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function MailboxIcon({ className = '', size = 24, color = 'currentColor', ...props }: MailboxIconProps) {
  return (
    <svg
