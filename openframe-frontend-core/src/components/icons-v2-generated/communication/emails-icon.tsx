...
export interface EmailsIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function EmailsIcon({ className = '', size = 24, color = 'currentColor', ...props }: EmailsIconProps) {
  return (
    <svg
