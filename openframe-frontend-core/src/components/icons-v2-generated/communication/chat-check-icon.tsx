...
export interface ChatCheckIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function ChatCheckIcon({ className = '', size = 24, color = 'currentColor', ...props }: ChatCheckIconProps) {
  return (
    <svg
    ...
    >
      ...
      <path
        fill={color}
        d="M15.705 8.205a1.125 1.125 0 1 1 1.59 1.59l-6 6c-.439.44-1.151.44-1.59 0l-3-3-.078-.085a1.126 1.126 0 0 1 1.584-1.583l.085.078 2.204 2.204z"
      />
    </svg>
  );
}
