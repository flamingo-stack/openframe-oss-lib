...
export interface MessagesIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function MessagesIcon({ className = '', size = 24, color = 'currentColor', ...props }: MessagesIconProps) {
  return (
    <svg
