...
export interface ChatXmarkIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function ChatXmarkIcon({ className = '', size = 24, color = 'currentColor', ...props }: ChatXmarkIconProps) {
  return (
    <svg
