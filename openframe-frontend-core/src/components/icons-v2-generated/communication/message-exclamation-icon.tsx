...
export interface MessageExclamationIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function MessageExclamationIcon({
  className = '',
  size = 24,
  color = 'currentColor',
  ...props
}: MessageExclamationIconProps) {
  return (
    <svg
    ...
    >
      ...
      <path
        fill={color}
        d="M10.876 10V7a1.125 1.125 0 0 1 2.25 0v3a1.125 1.125 0 0 1-2.25 0m2.498 4a1.374 1.374 0 0 1-2.742.141l-.007-.14.007-.141a1.375 1.375 0 0 1 1.369-1.235l.14.007a1.376 1.376 0 0 1 1.233 1.369Z"
      />
    </svg>
  );
}
