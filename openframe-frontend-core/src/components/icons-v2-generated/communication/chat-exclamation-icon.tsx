...
export interface ChatExclamationIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function ChatExclamationIcon({
  className = '',
  size = 24,
  color = 'currentColor',
  ...props
}: ChatExclamationIconProps) {
  return (
    <svg
    ...
    >
      ...
      <path
        fill={color}
        d="M10.876 12V8a1.125 1.125 0 0 1 2.25 0v4a1.126 1.126 0 0 1-2.25 0m2.499 3.99a1.374 1.374 0 0 1-2.743.14l-.007-.14.007-.14a1.375 1.375 0 0 1 1.369-1.235l.14.008c.693.07 1.234.656 1.234 1.368Z"
      />
    </svg>
  );
}
