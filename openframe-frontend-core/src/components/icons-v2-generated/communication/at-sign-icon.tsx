...
export interface AtSignIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function AtSignIcon({ className = '', size = 24, color = 'currentColor', ...props }: AtSignIconProps) {
  return (
    <svg
