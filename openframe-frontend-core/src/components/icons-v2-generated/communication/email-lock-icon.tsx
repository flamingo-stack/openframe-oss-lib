...
export interface EmailLockIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function EmailLockIcon({ className = '', size = 24, color = 'currentColor', ...props }: EmailLockIconProps) {
  return (
    <svg
