...
export interface InboxIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function InboxIcon({ className = '', size = 24, color = 'currentColor', ...props }: InboxIconProps) {
  return (
    <svg
