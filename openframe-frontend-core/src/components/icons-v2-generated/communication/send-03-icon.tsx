...
export interface Send03IconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function Send03Icon({ className = '', size = 24, color = 'currentColor', ...props }: Send03IconProps) {
  return (
    <svg
