...
export interface DeleteIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function DeleteIcon({ className = '', size = 24, color = 'currentColor', ...props }: DeleteIconProps) {
  return (
    <svg
