...
export interface ChatBlankIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function ChatBlankIcon({ className = '', size = 24, color = 'currentColor', ...props }: ChatBlankIconProps) {
  return (
    <svg
