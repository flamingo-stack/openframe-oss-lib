...
export interface ChatMinusIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function ChatMinusIcon({ className = '', size = 24, color = 'currentColor', ...props }: ChatMinusIconProps) {
  return (
    <svg
