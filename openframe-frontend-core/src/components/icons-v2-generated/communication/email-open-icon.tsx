...
export interface EmailOpenIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function EmailOpenIcon({ className = '', size = 24, color = 'currentColor', ...props }: EmailOpenIconProps) {
  return (
    <svg
