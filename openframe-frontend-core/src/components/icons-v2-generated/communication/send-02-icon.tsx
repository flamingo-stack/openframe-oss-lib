...
export interface Send02IconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function Send02Icon({ className = '', size = 24, color = 'currentColor', ...props }: Send02IconProps) {
  return (
    <svg
      ...
      {...props}
    >
      <path fill={color} d="m12 10.875.116.006a1.125 1.125 0 0 1 0 2.238l-.116.006H5.6a1.125 1.125 0 0 1 0-2.25z" />
      <path
        fill={color}
