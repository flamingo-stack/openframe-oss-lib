...
export interface DialpadIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function DialpadIcon({ className = '', size = 24, color = 'currentColor', ...props }: DialpadIconProps) {
  return (
    <svg
