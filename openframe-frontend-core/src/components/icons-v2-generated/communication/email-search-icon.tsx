...
export interface EmailSearchIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function EmailSearchIcon({ className = '', size = 24, color = 'currentColor', ...props }: EmailSearchIconProps) {
  return (
    <svg
