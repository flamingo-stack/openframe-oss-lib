...
export interface MessageMinusIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function MessageMinusIcon({
  className = '',
  size = 24,
  color = 'currentColor',
  ...props
}: MessageMinusIconProps) {
  return (
    <svg
    ...
    >
      ...
      />
      <path fill={color} d="m16 9.875.115.006a1.125 1.125 0 0 1 0 2.238l-.115.006H8a1.125 1.125 0 0 1 0-2.25z" />
    </svg>
  );
}
