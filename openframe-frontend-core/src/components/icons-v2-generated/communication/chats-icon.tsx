...
export interface ChatsIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function ChatsIcon({ className = '', size = 24, color = 'currentColor', ...props }: ChatsIconProps) {
  return (
    <svg
