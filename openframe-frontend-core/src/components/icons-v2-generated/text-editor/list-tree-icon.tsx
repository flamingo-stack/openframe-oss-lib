...
export interface ListTreeIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function ListTreeIcon({ className = '', size = 24, color = 'currentColor', ...props }: ListTreeIconProps) {
  return (
    <svg
