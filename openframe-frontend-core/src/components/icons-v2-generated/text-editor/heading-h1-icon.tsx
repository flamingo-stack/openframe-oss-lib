...
export interface HeadingH1IconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function HeadingH1Icon({ className = '', size = 24, color = 'currentColor', ...props }: HeadingH1IconProps) {
  return (
    <svg
