...
export interface SpacingHrIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function SpacingHrIcon({ className = '', size = 24, color = 'currentColor', ...props }: SpacingHrIconProps) {
  return (
    <svg
