...
export interface LineHeightIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function LineHeightIcon({ className = '', size = 24, color = 'currentColor', ...props }: LineHeightIconProps) {
  return (
    <svg
