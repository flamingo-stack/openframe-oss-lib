...
export interface ItalicIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function ItalicIcon({ className = '', size = 24, color = 'currentColor', ...props }: ItalicIconProps) {
  return (
    <svg
