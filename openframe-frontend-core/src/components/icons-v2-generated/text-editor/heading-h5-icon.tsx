...
export interface HeadingH5IconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function HeadingH5Icon({ className = '', size = 24, color = 'currentColor', ...props }: HeadingH5IconProps) {
  return (
    <svg
