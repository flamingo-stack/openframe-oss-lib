...
export interface HeadingAltIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function HeadingAltIcon({ className = '', size = 24, color = 'currentColor', ...props }: HeadingAltIconProps) {
  return (
    <svg
