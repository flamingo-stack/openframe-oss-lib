...
export interface HeadingH4IconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function HeadingH4Icon({ className = '', size = 24, color = 'currentColor', ...props }: HeadingH4IconProps) {
  return (
    <svg
