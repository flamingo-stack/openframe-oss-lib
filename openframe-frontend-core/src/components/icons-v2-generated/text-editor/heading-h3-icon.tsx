...
export interface HeadingH3IconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function HeadingH3Icon({ className = '', size = 24, color = 'currentColor', ...props }: HeadingH3IconProps) {
  return (
    <svg
