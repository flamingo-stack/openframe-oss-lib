...
export interface ICursorIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function ICursorIcon({ className = '', size = 24, color = 'currentColor', ...props }: ICursorIconProps) {
  return (
    <svg
    ...
    >
      ...
      />
      <path fill={color} d="m14.5 10.875.115.006a1.125 1.125 0 0 1 0 2.238l-.116.006H9.5a1.125 1.125 0 0 1 0-2.25z" />
    </svg>
  );
}
