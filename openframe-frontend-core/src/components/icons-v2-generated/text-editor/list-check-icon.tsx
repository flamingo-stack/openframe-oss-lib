...
export interface ListCheckIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function ListCheckIcon({ className = '', size = 24, color = 'currentColor', ...props }: ListCheckIconProps) {
  return (
    <svg
