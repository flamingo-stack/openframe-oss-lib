...
export interface HeadingH6IconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function HeadingH6Icon({ className = '', size = 24, color = 'currentColor', ...props }: HeadingH6IconProps) {
  return (
    <svg
