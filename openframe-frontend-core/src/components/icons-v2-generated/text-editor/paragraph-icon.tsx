...
export interface ParagraphIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function ParagraphIcon({ className = '', size = 24, color = 'currentColor', ...props }: ParagraphIconProps) {
  return (
    <svg
