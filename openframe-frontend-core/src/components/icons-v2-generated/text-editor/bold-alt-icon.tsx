...
export interface BoldAltIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function BoldAltIcon({ className = '', size = 24, color = 'currentColor', ...props }: BoldAltIconProps) {
  return (
    <svg
