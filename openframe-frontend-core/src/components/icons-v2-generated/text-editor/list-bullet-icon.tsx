...
export interface ListBulletIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function ListBulletIcon({ className = '', size = 24, color = 'currentColor', ...props }: ListBulletIconProps) {
  return (
    <svg
