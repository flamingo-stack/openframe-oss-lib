...
export interface SpacingVrIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function SpacingVrIcon({ className = '', size = 24, color = 'currentColor', ...props }: SpacingVrIconProps) {
  return (
    <svg
