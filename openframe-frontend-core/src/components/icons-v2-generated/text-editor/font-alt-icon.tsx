...
export interface FontAltIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function FontAltIcon({ className = '', size = 24, color = 'currentColor', ...props }: FontAltIconProps) {
  return (
    <svg
