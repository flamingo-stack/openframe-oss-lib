...
export interface UnderlineIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function UnderlineIcon({ className = '', size = 24, color = 'currentColor', ...props }: UnderlineIconProps) {
  return (
    <svg
