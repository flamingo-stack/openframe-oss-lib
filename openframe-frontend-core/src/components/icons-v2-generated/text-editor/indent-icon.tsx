...
export interface IndentIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function IndentIcon({ className = '', size = 24, color = 'currentColor', ...props }: IndentIconProps) {
  return (
    <svg
