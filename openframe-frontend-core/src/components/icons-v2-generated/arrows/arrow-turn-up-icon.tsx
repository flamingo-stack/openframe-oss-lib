...
export interface ArrowTurnUpIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function ArrowTurnUpIcon({ className = '', size = 24, color = 'currentColor', ...props }: ArrowTurnUpIconProps) {
  return (
    <svg
