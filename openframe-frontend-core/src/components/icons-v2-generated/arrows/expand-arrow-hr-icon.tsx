...
export interface ExpandArrowHrIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function ExpandArrowHrIcon({
  ...
  return (
    <svg
      ...
      {...props}
    >
      <path fill={color} d="m22 10.875.115.006a1.125 1.125 0 0 1 0 2.238l-.115.006H2a1.125 1.125 0 0 1 0-2.25z" />
      <path
        fill={color}
