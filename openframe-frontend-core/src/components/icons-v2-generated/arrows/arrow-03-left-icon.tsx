...
export interface Arrow03LeftIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function Arrow03LeftIcon({ className = '', size = 24, color = 'currentColor', ...props }: Arrow03LeftIconProps) {
  return (
    <svg
