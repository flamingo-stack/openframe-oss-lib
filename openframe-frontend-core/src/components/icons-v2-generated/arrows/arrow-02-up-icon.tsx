...
export interface Arrow02UpIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function Arrow02UpIcon({ className = '', size = 24, color = 'currentColor', ...props }: Arrow02UpIconProps) {
  return (
    <svg
