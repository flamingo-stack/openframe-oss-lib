...
export interface TransferHrIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function TransferHrIcon({ className = '', size = 24, color = 'currentColor', ...props }: TransferHrIconProps) {
  return (
    <svg
