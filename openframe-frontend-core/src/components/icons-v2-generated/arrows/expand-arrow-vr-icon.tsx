...
export interface ExpandArrowVrIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function ExpandArrowVrIcon({
  ...
  return (
    <svg
      ...
      {...props}
    >
      <path fill={color} d="M10.875 22V2a1.125 1.125 0 0 1 2.25 0v20a1.125 1.125 0 1 1-2.25 0" />
      <path
        fill={color}
