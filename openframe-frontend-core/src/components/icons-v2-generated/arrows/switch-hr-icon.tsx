...
export interface SwitchHrIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function SwitchHrIcon({ className = '', size = 24, color = 'currentColor', ...props }: SwitchHrIconProps) {
  return (
    <svg
