...
export interface Arrow03DownIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function Arrow03DownIcon({ className = '', size = 24, color = 'currentColor', ...props }: Arrow03DownIconProps) {
  return (
    <svg
