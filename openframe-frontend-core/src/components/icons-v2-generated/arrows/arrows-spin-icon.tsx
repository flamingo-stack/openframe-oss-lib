...
export interface ArrowsSpinIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function ArrowsSpinIcon({ className = '', size = 24, color = 'currentColor', ...props }: ArrowsSpinIconProps) {
  return (
    <svg
