...
export interface SodaCanIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function SodaCanIcon({ className = '', size = 24, color = 'currentColor', ...props }: SodaCanIconProps) {
  return (
    <svg
