...
export interface IceCreamIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function IceCreamIcon({ className = '', size = 24, color = 'currentColor', ...props }: IceCreamIconProps) {
  return (
    <svg
