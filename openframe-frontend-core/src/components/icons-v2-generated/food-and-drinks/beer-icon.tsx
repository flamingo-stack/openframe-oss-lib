...
export interface BeerIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function BeerIcon({ className = '', size = 24, color = 'currentColor', ...props }: BeerIconProps) {
  return (
    <svg
