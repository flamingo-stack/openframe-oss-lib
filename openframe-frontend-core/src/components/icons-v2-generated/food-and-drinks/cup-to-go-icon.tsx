...
export interface CupToGoIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function CupToGoIcon({ className = '', size = 24, color = 'currentColor', ...props }: CupToGoIconProps) {
  return (
    <svg
