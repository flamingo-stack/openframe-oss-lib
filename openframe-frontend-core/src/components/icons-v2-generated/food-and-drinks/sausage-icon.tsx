...
export interface SausageIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function SausageIcon({ className = '', size = 24, color = 'currentColor', ...props }: SausageIconProps) {
  return (
    <svg
