...
export interface JarIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function JarIcon({ className = '', size = 24, color = 'currentColor', ...props }: JarIconProps) {
  return (
    <svg
