...
export interface MilkCartonIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function MilkCartonIcon({ className = '', size = 24, color = 'currentColor', ...props }: MilkCartonIconProps) {
  return (
    <svg
