...
export interface GlassWineIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function GlassWineIcon({ className = '', size = 24, color = 'currentColor', ...props }: GlassWineIconProps) {
  return (
    <svg
      ...
      {...props}
    >
      <path fill={color} d="m17.86 6.875.114.006a1.125 1.125 0 0 1 0 2.238l-.114.006H6.14a1.125 1.125 0 0 1 0-2.25z" />
      <path
        fill={color}
