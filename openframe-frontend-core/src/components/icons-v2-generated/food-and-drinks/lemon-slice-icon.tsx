...
export interface LemonSliceIconProps extends Omit<SVGProps<SVGSVGElement>, 'width' | 'height'> {
  className?: string;
  size?: number;
  color?: string;
}
export function LemonSliceIcon({ className = '', size = 24, color = 'currentColor', ...props }: LemonSliceIconProps) {
  return (
    <svg
