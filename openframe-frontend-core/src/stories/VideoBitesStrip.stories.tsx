...
import { VideoBitesStrip, type VideoBiteStripItem } from '../components/features/video-bites-strip';
...
const SAMPLE_MP4 = 'https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/ForBiggerBlazes.mp4';
const SAMPLE_MP4_2 = 'https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/ForBiggerEscapes.mp4';
...
const MANY_MIXED: VideoBiteStripItem[] = [
  ...
  bite({
    ...
    aspect_ratio: '16:9',
    thumbnail_url: 'https://picsum.photos/seed/land/480/270',
    href: '#b',
  }),
