...
const meta = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component: 'Displays operating system type with icon and label. Automatically normalizes OS type strings from various sources like Fleet MDM, OpenFrame RMM, etc.',
      },
    },
  },
  tags: ['autodocs'],
