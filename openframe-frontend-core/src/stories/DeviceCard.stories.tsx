  ...
  args: {
    ...
    actions: {
      ...
      detailsButton: {
        visible: true,
        component: (
          <div className="box-border flex cursor-pointer items-center justify-center gap-2 rounded-[6px] border border-ods-border bg-ods-card px-4 py-3 transition-colors hover:bg-ods-bg-hover">
            <span className="tracking-[-0.36px] text-ods-text-primary text-h3">Details</span>
          </div>
        ),
      },
    },
