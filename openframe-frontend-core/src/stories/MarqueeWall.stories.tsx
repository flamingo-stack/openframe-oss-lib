...
const TILES = ['Datto RMM', 'ConnectWise', 'HaloPSA', 'SentinelOne', 'Proofpoint', 'Veeam', 'Auvik', 'IT Glue'];

function Tile({ label }: { label: string }) {
  return (
    <div className="flex h-16 w-48 shrink-0 items-center justify-center rounded-md border border-ods-border bg-ods-card text-ods-text-secondary text-h6">
      {label}
    </div>
  );
}
