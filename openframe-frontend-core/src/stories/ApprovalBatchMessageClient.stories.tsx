...
import type { ApprovalBatchData, PendingToolCallData } from '../components/chat/types';
...
const toolCall: PendingToolCallData = {
  ...
  toolExplanation: "Collects today's system, application, and security event logs and exports them to a CSV file.",
...
const plainDecorator = (width?: number) =>
  ...
  function PlainDecorator(Story: React.ComponentType) {
    return (
