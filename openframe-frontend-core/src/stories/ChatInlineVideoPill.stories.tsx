...
const meta: Meta<typeof ChatInlineVideoPill> = {
  ...
  decorators: [
    Story => (
      <ChatColumnDecorator>
        <p className="text-sm leading-relaxed text-ods-text-primary">
          Here is the demo from last week&apos;s call: <Story /> — watch the part where Jordan walks through the on-call
          rotation.
        </p>
      </ChatColumnDecorator>
    ),
