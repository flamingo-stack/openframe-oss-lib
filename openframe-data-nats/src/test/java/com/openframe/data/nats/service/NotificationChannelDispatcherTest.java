...
class NotificationChannelDispatcherTest {
    ...
    void delivers_to_every_user_on_every_channel() {
        ...
        NotificationChannelDispatcher dispatcher = dispatcher(List.of(fcm, slack), Optional.empty());
    ...
    void a_throwing_channel_is_swallowed_and_others_still_deliver() {
        ...
        NotificationChannelDispatcher dispatcher = dispatcher(List.of(fcm), Optional.empty());
    ...
    void no_channels_is_a_noop_and_skips_the_settings_lookup() {
        ...
        NotificationChannelDispatcher dispatcher = dispatcher(List.of(), Optional.of(settings));
    ...
    void muted_user_is_skipped_and_others_still_deliver() {
        ...
        NotificationChannelDispatcher dispatcher = dispatcher(List.of(fcm), Optional.of(settings));
    ...
    private static NotificationChannelDispatcher dispatcher(List<NotificationChannel> channels,
                                                             Optional<NotificationSettingsRepository> settings) {
        return new NotificationChannelDispatcher(channels, settings);
    }
