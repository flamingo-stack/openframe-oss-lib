...
class CustomScheduleScriptRepositoryImplSortTest {
    ...
    void encodeCursor_dateTime_usesStartAtMillis_bucketZero() {
        ...
        s.setTrigger(ScheduleScriptTrigger.DATE_TIME);
    ...
    void encodeCursor_deviceOnline_nullStartAt_isEmptyMillisBucketOne() {
        ...
        ScheduleScript s = new ScheduleScript();
        s.setId("507f1f77bcf86cd799439011");
        s.setTrigger(ScheduleScriptTrigger.DEVICE_ONLINE);   // startAt left null
