...
class NotificationReadStateServiceIT extends BaseMongoIntegrationTest {
    ...
    void unread_to_read_round_trip() {
        service.createForAudience("notif-1", CAT_TICKETS, U, Set.of(ALICE));
    ...
    void audience_isolation_by_id() {
        service.createForAudience("notif-1", CAT_TICKETS, U, Set.of(ALICE, BOB));
    ...
    void audience_isolation_by_type() {
        service.createForAudience("notif-user", CAT_TICKETS, U, Set.of(ALICE));
        service.createForAudience("notif-machine", CAT_TICKETS, M, Set.of(MACHINE_1));
    ...
    void mark_all_as_read() {
        service.createForAudience("n1", CAT_TICKETS, U, Set.of(ALICE));
        service.createForAudience("n2", CAT_TICKETS, U, Set.of(ALICE));
    ...
    void unread_counts_by_category() {
        service.createForAudience("n1", CAT_TICKETS, U, Set.of(ALICE));
        service.createForAudience("n2", CAT_TICKETS, U, Set.of(ALICE));
        service.createForAudience("n3", CAT_MINGO, U, Set.of(ALICE));
