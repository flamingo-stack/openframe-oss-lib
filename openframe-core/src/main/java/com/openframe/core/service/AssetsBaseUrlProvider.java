 ...
 * {@code DownloadConfigurationLinkResolver} (openframe-data-nats) falls back to the static
 ...
 *
 * <p>Lives in openframe-core so implementors (typically persistence-layer modules) don't have to
 * depend on the NATS messaging module — which carries a Spring Cloud Stream binder that must not
 * leak onto the classpath of services using another binder.
 */
