...
// public package-manager catalog stored once in the shared database; written by the sync side
// (PackageSearchSyncAutoConfiguration), read by the api side; not TenantScoped on purpose
@Data
@Builder
@NoArgsConstructor
@AllArgsConstructor
