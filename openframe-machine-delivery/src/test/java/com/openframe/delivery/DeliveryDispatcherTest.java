...
class DeliveryDispatcherTest {
    ...
    void dispatch_seed_requestRecordedThenPublishedThroughSpec() {
        ...
        when(spec.getSeedClass()).thenReturn(TestSeed.class);
    ...
    void dispatch_unregisteredType_throwsWithoutRecording() {
        ...
        // execution
        IllegalArgumentException ex = assertThrows(IllegalArgumentException.class, () -> dispatcher.dispatch(seed));

        // verifications
        assertThat(ex.getMessage()).contains("TOOL_INSTALLATION");
